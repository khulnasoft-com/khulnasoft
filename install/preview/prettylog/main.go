...
var (
	...
	msgs           = []struct {
		...
		{Msg: "checking prerequisites", Fail: "requires a system with at least", Success: "Khulnasoft Domain:", Status: "checking prerequisites"},
		{Msg: "preparing system", Success: "extracting images to download ahead"},
		{Msg: "downloading images", Success: "images pulled"},
		{Msg: "preparing Khulnasoft preview installation", Success: "manifests generated"},
		{Msg: "starting Khulnasoft", Success: "Khulnasoft pods are ready", Status: "starting khulnasoft"},
		{Msg: fmt.Sprintf("Khulnasoft is running. Visit https://%s to access the dashboard", os.Getenv("DOMAIN")), Status: "khulnasoft ready"},
	}
)
...
Welcome to the local preview of Khulnasoft. Please note the following limitations:
...
For more information about these limitation, please visit the local preview documentation: https://www.khulnasoft.com/docs/self-hosted/latest/local-preview`)
