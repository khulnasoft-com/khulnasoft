...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/installer/pkg/containerd"
...
var (
	defaultRepositoryUrl = config.KhulnasoftContainerRegistry
)
...
// Config defines the v1 version structure of the khulnasoft config file
type Config struct {
...
// Taken from github.com/khulnasoft-com/khulnasoft/components/khulnasoft-protocol/src/util/logging.ts
const (
