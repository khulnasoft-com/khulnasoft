...
|`repository`|string|Y|  ||
|`observability.logLevel`|string|N| `trace`, `debug`, `info`, `warning`, `error`, `fatal`, `panic` |Taken from github.com/khulnasoft-com/khulnasoft/components/khulnasoft-protocol/src/util/logging.ts|
...
|`apiVersion`|string|Y|  |API version of the Khulnasoft config defintion. `v1` in this version of Config|
