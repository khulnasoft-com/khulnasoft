...
// outside of Khulnasoft to use.
//
// Changes in this section will NOT be backwards compatible change at will without prior notice.
// If you use any setting herein, you forfeit support from Khulnasoft.
package experimental

import (
	"time"

	agentSmith "github.com/khulnasoft-com/khulnasoft/agent-smith/pkg/config"
	"github.com/khulnasoft-com/khulnasoft/common-go/grpc"
...
type WorkspaceConfig struct {
	...
	WSProxy struct {
		...
		KhulnasoftInstallationHostName                 string `json:"khulnasoftInstallationHostName"`
		KhulnasoftInstallationWorkspaceHostSuffix      string `json:"khulnasoftInstallationWorkspaceHostSuffix"`
		KhulnasoftInstallationWorkspaceHostSuffixRegex string `json:"khulnasoftInstallationWorkspaceHostSuffixRegex"`
	} `json:"wsProxy"`
...
type WebAppConfig struct {
	...
	// PublicURL lets you override the publically reachable endpoints of khulnasoft (currently only public api endpoint)
	...
	// ProxySettings is used if the khulnasoft cell uses some proxy for connectivity
