...
import (
	...
	content_service "github.com/khulnasoft-com/khulnasoft/installer/pkg/components/content-service"
...
func TestRepoName(t *testing.T) {
	...
	tests := []struct {
		...
		{
			Name: "khulnasoft-com/workspace-full",
			Expectation: Expectation{
				Result: "docker.io/khulnasoft-com/workspace-full",
			},
		},
		{
			Repo: "some-repo.com",
		...
		// Drop repo, namespace
		{
			Name: "khulnasoft-com/workspace-full",
			Expectation: Expectation{
				Result: "some.registry.com/khulnasoft/workspace-full",
			},
			CfgRepo:       "some.registry.com/khulnasoft",
			DropImageRepo: pointer.Bool(true),
		},
		{
			Repo: "some-repo.com",
			Name: "some-image",
			Expectation: Expectation{
				Result: "some.registry.com/khulnasoft/some-image",
			},
			CfgRepo:       "some.registry.com/khulnasoft",
			DropImageRepo: pointer.Bool(true),
		},
