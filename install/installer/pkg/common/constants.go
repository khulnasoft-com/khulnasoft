...
var (
	KhulnasoftContainerRegistry = config.KhulnasoftContainerRegistry
)

const (
	AppName                     = "khulnasoft"
	BlobServeServicePort        = 4000
	CertManagerCAIssuer         = "khulnasoft-ca-issuer"
	...
	AnnotationConfigChecksum    = "khulnasoft.com/checksum_config"
