...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/installer/pkg/config/versions"
...
func TestPublicApiServerComponentWaiterContainer(t *testing.T) {
	...
	ctx.Config.Repository = "docker.io/khulnasoft/core-dev/testing/installer"
	...
	require.Equal(t, labels, "app=khulnasoft,component=public-api-server")
...
func TestServerComponentWaiterContainer(t *testing.T) {
	...
	require.Equal(t, labels, "app=khulnasoft,component=server")
...
func TestConfigcatEnvOutOfCluster(t *testing.T) {
	...
	require.Equal(t, envVars, []v1.EnvVar([]v1.EnvVar{{Name: "CONFIGCAT_SDK_KEY", Value: "khulnasoft"}, {Name: "CONFIGCAT_BASE_URL", Value: "https://khulnasoft.com/configcat"}}))
}
