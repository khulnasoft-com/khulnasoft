	...
	initContainers := []corev1.Container{
		{
			...
			VolumeMounts: []corev1.VolumeMount{
				...
				{
					Name:      "ca-certificate",
					MountPath: "/usr/local/share/ca-certificates/khulnasoft-ca.crt",
					SubPath:   "khulnasoft-ca.crt",
					ReadOnly:  true,
				},
			},
						...
						},
						{
							...
							VolumeSource: corev1.VolumeSource{
								ConfigMap: &corev1.ConfigMapVolumeSource{
									LocalObjectReference: corev1.LocalObjectReference{Name: "khulnasoft-ca"},
								},
							},
						},
						common.CAVolume(),
