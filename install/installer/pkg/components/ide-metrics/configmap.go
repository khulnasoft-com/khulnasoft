...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/ide-metrics-api/config"
...
func configmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	counterMetrics := []config.CounterMetricsConfiguration{
		...
		{
			Name: "khulnasoft_supervisor_frontend_error_total",
		...
		{
			Name: "khulnasoft_vscode_web_load_total",
		...
		{
			Name: "khulnasoft_supervisor_frontend_client_total",
			Help: "Total count of supervisor frontend client",
		},
		{
			Name: "khulnasoft_vscode_extension_gallery_operation_total",
		...
		{
			Name: "khulnasoft_vscode_extension_gallery_query_total",
		...
		},
		{
			...
			Labels: []config.LabelAllowList{
				{
					Name:         "origin",
					AllowValues:  []string{"unknown", "workspace", "khulnasoft", "localhost"},
					DefaultValue: "unknown",
				},
				{
					Name:         "instance_phase",
	...
	histogramMetrics := []config.HistogramMetricsConfiguration{
		{
			Name: "khulnasoft_vscode_extension_gallery_operation_duration_seconds",
			...
			Name: "khulnasoft_vscode_extension_gallery_query_duration_seconds",
