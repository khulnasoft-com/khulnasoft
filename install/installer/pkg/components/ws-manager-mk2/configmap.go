...
import (
	...
	storageconfig "github.com/khulnasoft-com/khulnasoft/content-service/api/config"
...
func configmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	khulnasoftHostURL := "https://" + ctx.Config.Domain
	...
	err = ctx.WithExperimental(func(ucfg *experimental.Config) error {
		...
		if ucfg.Workspace.HostURL != "" {
			khulnasoftHostURL = ucfg.Workspace.HostURL
		}
	...
	if ctx.Config.Kind == configv1.InstallationWorkspace {
		...
		// (https://github.com/khulnasoft-com/khulnasoft/issues/7845).
	...
	wsmcfg := config.ServiceConfiguration{
		Manager: config.Configuration{
			...
			KhulnasoftHostURL:           khulnasoftHostURL,
