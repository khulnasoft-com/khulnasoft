...
func init() {
	...
	ideConfigmapCmd.PersistentFlags().StringVarP(&ideOpts.ConfigFN, "config", "c", getEnvvar("KHULNASOFT_INSTALLER_CONFIG", filepath.Join(dir, "khulnasoft.config.yaml")), "path to the config file, use - for stdin")
