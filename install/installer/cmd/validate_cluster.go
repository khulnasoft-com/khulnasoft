...
func init() {
	...
	validateClusterCmd.PersistentFlags().StringVarP(&validateClusterOpts.Config, "config", "c", getEnvvar("KHULNASOFT_INSTALLER_CONFIG", filepath.Join(dir, "khulnasoft.config.yaml")), "path to the config file")
