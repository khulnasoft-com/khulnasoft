...
func init() {
	...
	configCmd.PersistentFlags().StringVarP(&configOpts.ConfigFile, "config", "c", getEnvvar("KHULNASOFT_INSTALLER_CONFIG", filepath.Join(dir, "khulnasoft.config.yaml")), "path to the configuration file")
}
