...
func init() {
	...
	validateCmd.PersistentFlags().StringVarP(&validateConfigOpts.Config, "config", "c", getEnvvar("KHULNASOFT_INSTALLER_CONFIG", filepath.Join(dir, "khulnasoft.config.yaml")), "path to the config file")
}
