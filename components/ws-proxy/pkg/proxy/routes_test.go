...
import (
	...
	server_lib "github.com/khulnasoft-com/khulnasoft/server/go/pkg/lib"
	"github.com/khulnasoft-com/khulnasoft/ws-manager/api"
	"github.com/khulnasoft-com/khulnasoft/ws-proxy/pkg/common"
	"github.com/khulnasoft-com/khulnasoft/ws-proxy/pkg/sshproxy"
)
...
var (
	...
	workspaces        = []common.WorkspaceInfo{
		{
			IDEImage:        "khulnasoft-com/ide:latest",
			SupervisorImage: "khulnasoft-com/supervisor:latest",
	...
	config = Config{
		...
		KhulnasoftInstallation: &KhulnasoftInstallation{
	...
	tests := []struct {
	...
	}{
		{
			...
			Expectation: Expectation{
				...
				Header: http.Header{
					...
					"Location": {
						"https://ide.test-domain.com/blobserve/khulnasoft-com/supervisor:latest/__files__/favicon.ico",
					},
					"Vary": {"Accept-Encoding"},
				},
				Body: "<a href=\"https://ide.test-domain.com/blobserve/khulnasoft-com/supervisor:latest/__files__/favicon.ico\">See Other</a>.\n\n",
			},
		},
		{
			Desc: "/health",
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Header: http.Header{
					"Content-Type": {"text/html; charset=utf-8"},
					"Location":     {"https://ide.test-domain.com/blobserve/khulnasoft-com/ide:latest/__files__/"},
					"Vary":         {"Accept-Encoding"},
				},
				Body: "<a href=\"https://ide.test-domain.com/blobserve/khulnasoft-com/ide:latest/__files__/\">See Other</a>.\n\n",
			},
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "blobserve hit: /khulnasoft-com/ide:latest/\nhost: localhost:20003\ninlineVars: {\"ide\":\"https://ide.test-domain.com/blobserve/khulnasoft-com/ide:latest/__files__\",\"supervisor\":\"https://ide.test-domain.com/blobserve/khulnasoft-com/supervisor:latest/__files__\"}\n",
			},
		},
		{
		...
		},
		{
			...
			Request: modifyRequest(httptest.NewRequest("GET", workspaces[0].URL+"somewhere/in/the/ide", nil),
				addHostHeader,
				addOwnerToken(domain, workspaces[0].InstanceID, workspaces[0].Auth.OwnerToken),
				addHeader("Origin", config.KhulnasoftInstallation.HostName),
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "blobserve hit: /khulnasoft-com/supervisor:latest/worker-proxy.js\nhost: localhost:20003\n",
			},
		},
		{
			...
			Expectation: Expectation{
				...
				Header: http.Header{
					"Content-Type": {"text/html; charset=utf-8"},
					"Location":     {"https://ide.test-domain.com/blobserve/khulnasoft-com/supervisor:latest/__files__/main.js"},
					"Vary":         {"Accept-Encoding"},
				},
				Body: "<a href=\"https://ide.test-domain.com/blobserve/khulnasoft-com/supervisor:latest/__files__/main.js\">See Other</a>.\n\n",
			},
		},
		{
...
func TestRemoveSensitiveCookies(t *testing.T) {
	var (
		...
		realKhulnasoftSessionCookie = &http.Cookie{Domain: domain, Name: server_lib.CookieNameFromDomain(domain), Value: "fobar"}
	...
	tests := []struct {
		...
		{Name: "real Khulnasoft session cookie", Input: []*http.Cookie{realKhulnasoftSessionCookie, miscCookie}, Expected: []*http.Cookie{miscCookie}},
