...
type Config struct {
	...
	KhulnasoftInstallation *KhulnasoftInstallation `json:"khulnasoftInstallation"`
...
// KhulnasoftInstallation contains config regarding the Khulnasoft installation.
type KhulnasoftInstallation struct {
...
// Validate validates the configuration to catch issues during startup and not at runtime.
func (c *KhulnasoftInstallation) Validate() error {
	if c == nil {
		return xerrors.Errorf("KhulnasoftInstallation not configured")
	}
