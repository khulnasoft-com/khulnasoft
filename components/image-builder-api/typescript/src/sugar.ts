...
import { createClientCallMetricsInterceptor, IClientCallMetrics, isConnectionAlive } from "@khulnasoft/khulnasoft-protocol/lib/util/grpc";
...
import { ImageBuildLogInfo, User, Workspace, WorkspaceInstance } from "@khulnasoft/khulnasoft-protocol";
