...
type WorkspaceInfoResponse struct {
	...
	KhulnasoftApi *WorkspaceInfoResponse_KhulnasoftAPI `protobuf:"bytes,7,opt,name=khulnasoft_api,json=khulnasoftApi,proto3" json:"khulnasoft_api,omitempty"`
	// khulnasoft_host provides Khulnasoft host URL.
	KhulnasoftHost string `protobuf:"bytes,8,opt,name=khulnasoft_host,json=khulnasoftHost,proto3" json:"khulnasoft_host,omitempty"`
...
func (x *WorkspaceInfoResponse) GetKhulnasoftApi() *WorkspaceInfoResponse_KhulnasoftAPI {
	if x != nil {
		return x.KhulnasoftApi
	}
	return nil
}

func (x *WorkspaceInfoResponse) GetKhulnasoftHost() string {
	if x != nil {
		return x.KhulnasoftHost
	}
	return ""
}
...
type WorkspaceInfoResponse_KhulnasoftAPI struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceInfoResponse_KhulnasoftAPI) Reset() {
	*x = WorkspaceInfoResponse_KhulnasoftAPI{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceInfoResponse_KhulnasoftAPI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceInfoResponse_KhulnasoftAPI) ProtoMessage() {}

func (x *WorkspaceInfoResponse_KhulnasoftAPI) ProtoReflect() protoreflect.Message {
	mi := &file_info_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceInfoResponse_KhulnasoftAPI.ProtoReflect.Descriptor instead.
func (*WorkspaceInfoResponse_KhulnasoftAPI) Descriptor() ([]byte, []int) {
	return file_info_proto_rawDescGZIP(), []int{1, 0}
}

func (x *WorkspaceInfoResponse_KhulnasoftAPI) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *WorkspaceInfoResponse_KhulnasoftAPI) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
var file_info_proto_goTypes = []interface{}{
	...
	(*WorkspaceInfoResponse_KhulnasoftAPI)(nil),      // 3: supervisor.WorkspaceInfoResponse.KhulnasoftAPI
...
var file_info_proto_depIdxs = []int32{
	3, // 0: supervisor.WorkspaceInfoResponse.khulnasoft_api:type_name -> supervisor.WorkspaceInfoResponse.KhulnasoftAPI
...
func file_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_info_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceInfoResponse_KhulnasoftAPI); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
