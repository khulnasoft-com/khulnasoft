...
import (
	...
	cntntcfg "github.com/khulnasoft-com/khulnasoft/content-service/api/config"
)
...
type Configuration struct {
	...
	// - `Host` which is the KhulnasoftHostURL
	...
	// Is the URL under which Khulnasoft is installed (e.g. https://khulnasoft.com)
	KhulnasoftHostURL string `json:"hostURL"`
	...
	// Cluster host under which workspaces are served, e.g. ws-eu11.khulnasoft.com
...
func (c *Configuration) Validate() error {
	...
	err = ozzo.ValidateStruct(c,
		...
		ozzo.Field(&c.KhulnasoftHostURL, ozzo.Required, is.URL),
...
var validWorkspaceURLTemplate = ozzo.By(func(o interface{}) error {
	...
	wsurl, err := RenderWorkspaceURL(s, "foo", "bar", "khulnasoft.com")
	if err != nil {
