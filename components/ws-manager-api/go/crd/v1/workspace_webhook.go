...
//+kubebuilder:webhook:path=/mutate-workspace-khulnasoft-com-v1-workspace,mutating=true,failurePolicy=fail,sideEffects=None,groups=workspace.khulnasoft.com,resources=workspaces,verbs=create;update,versions=v1,name=mworkspace.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-workspace-khulnasoft-com-v1-workspace,mutating=false,failurePolicy=fail,sideEffects=None,groups=workspace.khulnasoft.com,resources=workspaces,verbs=create;update,versions=v1,name=vworkspace.kb.io,admissionReviewVersions=v1
