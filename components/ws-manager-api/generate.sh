...
mockgen \
    -package mock \
    github.com/khulnasoft-com/khulnasoft/ws-manager/api WorkspaceManager_SubscribeServer,WorkspaceManagerServer,WorkspaceManager_SubscribeClient,WorkspaceManagerClient > mock/mock.go
