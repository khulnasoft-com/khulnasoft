...
import { PermissionName, RolesOrPermissions, User, Workspace, WorkspaceInstance } from "@khulnasoft/khulnasoft-protocol";
import { AdmissionConstraint, WorkspaceClusterWoTLS } from "@khulnasoft/khulnasoft-protocol/lib/workspace-cluster";
