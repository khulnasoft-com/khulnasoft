...
import { createClientCallMetricsInterceptor, IClientCallMetrics } from "@khulnasoft/khulnasoft-protocol/lib/util/grpc";
import { Disposable, User, Workspace, WorkspaceInstance } from "@khulnasoft/khulnasoft-protocol";
...
import {
    ...
    WorkspaceRegion,
} from "@khulnasoft/khulnasoft-protocol/lib/workspace-cluster";
