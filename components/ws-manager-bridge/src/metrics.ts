...
import { WorkspaceType } from "@khulnasoft/khulnasoft-protocol";
...
export class Metrics {
    ...
    constructor() {
        ...
        this.staleStatusUpdatesTotal = new prom.Counter({
            name: "khulnasoft_ws_manager_bridge_stale_status_updates_total",
        ...
        this.stalePrebuildEventsTotal = new prom.Counter({
            name: "khulnasoft_ws_manager_bridge_stale_prebuild_events_total",
        ...
        this.workspaceInstanceUpdateStartedTotal = new prom.Counter({
            name: "khulnasoft_ws_manager_bridge_workspace_instance_update_started_total",
        ...
        this.workspaceInstanceUpdateCompletedSeconds = new prom.Histogram({
            name: "khulnasoft_ws_manager_bridge_workspace_instance_update_completed_seconds",
        ...
        this.prebuildsCompletedTotal = new prom.Counter({
            name: "khulnasoft_prebuilds_completed_total",
            help: "Counter of total prebuilds ended.",
            labelNames: ["state"],
        });

        this.instanceMarkedStoppedTotal = new prom.Counter({
            name: "khulnasoft_ws_instances_marked_stopped_total",
