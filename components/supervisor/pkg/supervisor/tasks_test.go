...
func TestTaskManager(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Command: &skipCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &skipCommand}, {Init: &skipCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &failCommand}, {Init: &failCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &failCommand}, {Init: &skipCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &skipCommand}, {Init: &failCommand}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testJSONObjectCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testEscapedJSONObject, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testJSONArrayCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testStringEnvCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testBooleanEnvCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testNullEnvCommand, Env: exampleEnvVarInputs}},
		...
		},
		{
			...
			Headless:    true,
			Source:      csapi.WorkspaceInitFromOther,
			KhulnasoftTasks: &[]TaskConfig{{Init: &testNumberEnvCommand, Env: exampleEnvVarInputs}},
	...
	for _, test := range tests {
		t.Run(test.Desc, func(t *testing.T) {
			...
			khulnasoftTasks := ""
			if test.KhulnasoftTasks != nil {
				result, err := json.Marshal(test.KhulnasoftTasks)
				if err != nil {
					t.Fatal(err)
				}
				khulnasoftTasks = string(result)
			}
			...
			var (
				...
				taskManager     = newTasksManager(&Config{
					WorkspaceConfig: WorkspaceConfig{
						KhulnasoftTasks:    khulnasoftTasks,
						KhulnasoftHeadless: strconv.FormatBool(test.Headless),
					},
