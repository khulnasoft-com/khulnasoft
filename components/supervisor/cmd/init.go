...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/supervisor/pkg/supervisor"
...
var initCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			log.WithError(err).Fatal("cannot find git executable, make sure it is installed as part of khulnasoft image")
		}
...
func newShutdownLogger() shutdownLogger {
	file := "/workspace/.khulnasoft/supervisor-termination.log"
