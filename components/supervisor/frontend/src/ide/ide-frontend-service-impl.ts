...
import { IDEFrontendService, IDEFrontendState } from "@khulnasoft/khulnasoft-protocol/lib/ide-frontend-service";
import { Disposable, DisposableCollection } from "@khulnasoft/khulnasoft-protocol/lib/util/disposable";
import { Emitter } from "@khulnasoft/khulnasoft-protocol/lib/util/event";
