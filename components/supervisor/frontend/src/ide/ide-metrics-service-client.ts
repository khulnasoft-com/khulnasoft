...
import { MetricsReporter } from "@khulnasoft/khulnasoft-protocol/lib/metrics";

export const metricsReporter = new MetricsReporter({
    khulnasoftUrl: serverUrl.toString(),
...
export enum MetricsName {
    SupervisorFrontendClientTotal = "khulnasoft_supervisor_frontend_client_total",
    SupervisorFrontendErrorTotal = "khulnasoft_supervisor_frontend_error_total",
    SupervisorFrontendLoadTotal = "khulnasoft_vscode_web_load_total",
}
