...
pushd "go"
  go install github.com/khulnasoft-com/khulnasoft/components/public-api/go/protoc-proxy-gen
popd
...
buf breaking --against "https://github.com/khulnasoft-com/khulnasoft.git#branch=main,subdir=components/public-api"
