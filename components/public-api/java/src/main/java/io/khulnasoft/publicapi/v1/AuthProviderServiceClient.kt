...
public class AuthProviderServiceClient(
  ...
  override suspend fun createAuthProvider(request: Authprovider.CreateAuthProviderRequest,
    ...
    "khulnasoft.v1.AuthProviderService/CreateAuthProvider",
      io.khulnasoft.publicapi.v1.Authprovider.CreateAuthProviderRequest::class,
      io.khulnasoft.publicapi.v1.Authprovider.CreateAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getAuthProvider(request: Authprovider.GetAuthProviderRequest,
    ...
    "khulnasoft.v1.AuthProviderService/GetAuthProvider",
      io.khulnasoft.publicapi.v1.Authprovider.GetAuthProviderRequest::class,
      io.khulnasoft.publicapi.v1.Authprovider.GetAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listAuthProviders(request: Authprovider.ListAuthProvidersRequest,
    ...
    "khulnasoft.v1.AuthProviderService/ListAuthProviders",
      io.khulnasoft.publicapi.v1.Authprovider.ListAuthProvidersRequest::class,
      io.khulnasoft.publicapi.v1.Authprovider.ListAuthProvidersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "khulnasoft.v1.AuthProviderService/ListAuthProviderDescriptions",
      io.khulnasoft.publicapi.v1.Authprovider.ListAuthProviderDescriptionsRequest::class,
      io.khulnasoft.publicapi.v1.Authprovider.ListAuthProviderDescriptionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateAuthProvider(request: Authprovider.UpdateAuthProviderRequest,
    ...
    "khulnasoft.v1.AuthProviderService/UpdateAuthProvider",
      io.khulnasoft.publicapi.v1.Authprovider.UpdateAuthProviderRequest::class,
      io.khulnasoft.publicapi.v1.Authprovider.UpdateAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteAuthProvider(request: Authprovider.DeleteAuthProviderRequest,
    ...
    "khulnasoft.v1.AuthProviderService/DeleteAuthProvider",
      io.khulnasoft.publicapi.v1.Authprovider.DeleteAuthProviderRequest::class,
      io.khulnasoft.publicapi.v1.Authprovider.DeleteAuthProviderResponse::class,
      StreamType.UNARY,
    ),
  )
