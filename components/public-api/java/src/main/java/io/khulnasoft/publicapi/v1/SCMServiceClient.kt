...
public class SCMServiceClient(
  ...
  override suspend fun searchSCMTokens(request: Scm.SearchSCMTokensRequest, headers: Headers):
    ...
    "khulnasoft.v1.SCMService/SearchSCMTokens",
      io.khulnasoft.publicapi.v1.Scm.SearchSCMTokensRequest::class,
      io.khulnasoft.publicapi.v1.Scm.SearchSCMTokensResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun guessTokenScopes(request: Scm.GuessTokenScopesRequest, headers: Headers):
    ...
    "khulnasoft.v1.SCMService/GuessTokenScopes",
      io.khulnasoft.publicapi.v1.Scm.GuessTokenScopesRequest::class,
      io.khulnasoft.publicapi.v1.Scm.GuessTokenScopesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun searchRepositories(request: Scm.SearchRepositoriesRequest, headers: Headers):
    ...
    "khulnasoft.v1.SCMService/SearchRepositories",
      io.khulnasoft.publicapi.v1.Scm.SearchRepositoriesRequest::class,
      io.khulnasoft.publicapi.v1.Scm.SearchRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listSuggestedRepositories(request: Scm.ListSuggestedRepositoriesRequest,
    ...
    "khulnasoft.v1.SCMService/ListSuggestedRepositories",
      io.khulnasoft.publicapi.v1.Scm.ListSuggestedRepositoriesRequest::class,
      io.khulnasoft.publicapi.v1.Scm.ListSuggestedRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
