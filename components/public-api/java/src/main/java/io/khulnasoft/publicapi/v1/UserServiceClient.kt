...
public class UserServiceClient(
  ...
  override suspend fun getAuthenticatedUser(request: UserOuterClass.GetAuthenticatedUserRequest,
    ...
    "khulnasoft.v1.UserService/GetAuthenticatedUser",
      io.khulnasoft.publicapi.v1.UserOuterClass.GetAuthenticatedUserRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.GetAuthenticatedUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateUser(request: UserOuterClass.UpdateUserRequest, headers: Headers):
    ...
    "khulnasoft.v1.UserService/UpdateUser",
      io.khulnasoft.publicapi.v1.UserOuterClass.UpdateUserRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.UpdateUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "khulnasoft.v1.UserService/SetWorkspaceAutoStartOptions",
      io.khulnasoft.publicapi.v1.UserOuterClass.SetWorkspaceAutoStartOptionsRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.SetWorkspaceAutoStartOptionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteUser(request: UserOuterClass.DeleteUserRequest, headers: Headers):
    ...
    "khulnasoft.v1.UserService/DeleteUser",
      io.khulnasoft.publicapi.v1.UserOuterClass.DeleteUserRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.DeleteUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun verifyUser(request: UserOuterClass.VerifyUserRequest, headers: Headers):
    ...
    "khulnasoft.v1.UserService/VerifyUser",
      io.khulnasoft.publicapi.v1.UserOuterClass.VerifyUserRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.VerifyUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun blockUser(request: UserOuterClass.BlockUserRequest, headers: Headers):
    ...
    "khulnasoft.v1.UserService/BlockUser",
      io.khulnasoft.publicapi.v1.UserOuterClass.BlockUserRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.BlockUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listUsers(request: UserOuterClass.ListUsersRequest, headers: Headers):
    ...
    "khulnasoft.v1.UserService/ListUsers",
      io.khulnasoft.publicapi.v1.UserOuterClass.ListUsersRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.ListUsersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getUser(request: UserOuterClass.GetUserRequest, headers: Headers):
    ...
    "khulnasoft.v1.UserService/GetUser",
      io.khulnasoft.publicapi.v1.UserOuterClass.GetUserRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.GetUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun setRolesOrPermissions(request: UserOuterClass.SetRolesOrPermissionsRequest,
    ...
    "khulnasoft.v1.UserService/SetRolesOrPermissions",
      io.khulnasoft.publicapi.v1.UserOuterClass.SetRolesOrPermissionsRequest::class,
      io.khulnasoft.publicapi.v1.UserOuterClass.SetRolesOrPermissionsResponse::class,
      StreamType.UNARY,
    ),
  )
