...
public class SSHServiceClient(
  ...
  override suspend fun listSSHPublicKeys(request: Ssh.ListSSHPublicKeysRequest, headers: Headers):
    ...
    "khulnasoft.v1.SSHService/ListSSHPublicKeys",
      io.khulnasoft.publicapi.v1.Ssh.ListSSHPublicKeysRequest::class,
      io.khulnasoft.publicapi.v1.Ssh.ListSSHPublicKeysResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun createSSHPublicKey(request: Ssh.CreateSSHPublicKeyRequest, headers: Headers):
    ...
    "khulnasoft.v1.SSHService/CreateSSHPublicKey",
      io.khulnasoft.publicapi.v1.Ssh.CreateSSHPublicKeyRequest::class,
      io.khulnasoft.publicapi.v1.Ssh.CreateSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteSSHPublicKey(request: Ssh.DeleteSSHPublicKeyRequest, headers: Headers):
    ...
    "khulnasoft.v1.SSHService/DeleteSSHPublicKey",
      io.khulnasoft.publicapi.v1.Ssh.DeleteSSHPublicKeyRequest::class,
      io.khulnasoft.publicapi.v1.Ssh.DeleteSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
