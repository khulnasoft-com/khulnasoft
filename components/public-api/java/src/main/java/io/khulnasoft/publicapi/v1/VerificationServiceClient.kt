...
public class VerificationServiceClient(
  ...
  override suspend
    ...
    "khulnasoft.v1.VerificationService/SendPhoneNumberVerificationToken",
      io.khulnasoft.publicapi.v1.Verification.SendPhoneNumberVerificationTokenRequest::class,
      io.khulnasoft.publicapi.v1.Verification.SendPhoneNumberVerificationTokenResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "khulnasoft.v1.VerificationService/VerifyPhoneNumberVerificationToken",
      io.khulnasoft.publicapi.v1.Verification.VerifyPhoneNumberVerificationTokenRequest::class,
      io.khulnasoft.publicapi.v1.Verification.VerifyPhoneNumberVerificationTokenResponse::class,
      StreamType.UNARY,
    ),
  )
