...
public class IDEClientServiceClient(
  ...
  override suspend fun sendHeartbeat(request: IdeClient.SendHeartbeatRequest, headers: Headers):
    ...
    "khulnasoft.experimental.v1.IDEClientService/SendHeartbeat",
      io.khulnasoft.publicapi.experimental.v1.IdeClient.SendHeartbeatRequest::class,
      io.khulnasoft.publicapi.experimental.v1.IdeClient.SendHeartbeatResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun sendDidClose(request: IdeClient.SendDidCloseRequest, headers: Headers):
    ...
    "khulnasoft.experimental.v1.IDEClientService/SendDidClose",
      io.khulnasoft.publicapi.experimental.v1.IdeClient.SendDidCloseRequest::class,
      io.khulnasoft.publicapi.experimental.v1.IdeClient.SendDidCloseResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateGitStatus(request: IdeClient.UpdateGitStatusRequest, headers: Headers):
    ...
    "khulnasoft.experimental.v1.IDEClientService/UpdateGitStatus",
      io.khulnasoft.publicapi.experimental.v1.IdeClient.UpdateGitStatusRequest::class,
      io.khulnasoft.publicapi.experimental.v1.IdeClient.UpdateGitStatusResponse::class,
      StreamType.UNARY,
    ),
  )
