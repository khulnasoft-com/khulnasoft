...
// @generated from file khulnasoft/v1/token.proto (package khulnasoft.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message khulnasoft.v1.CreateTemporaryAccessTokenRequest
 */
export class CreateTemporaryAccessTokenRequest extends Message<CreateTemporaryAccessTokenRequest> {
  ...
  static readonly typeName = "khulnasoft.v1.CreateTemporaryAccessTokenRequest";
...
/**
 * @generated from message khulnasoft.v1.CreateTemporaryAccessTokenResponse
 */
export class CreateTemporaryAccessTokenResponse extends Message<CreateTemporaryAccessTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.CreateTemporaryAccessTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
