...
// @generated from file khulnasoft/v1/configuration.proto (package khulnasoft.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum khulnasoft.v1.PrebuildTriggerStrategy
 */
...
proto3.util.setEnumType(PrebuildTriggerStrategy, "khulnasoft.v1.PrebuildTriggerStrategy", [
  { no: 0, name: "PREBUILD_TRIGGER_STRATEGY_UNSPECIFIED" },
  { no: 1, name: "PREBUILD_TRIGGER_STRATEGY_ACTIVITY_BASED" },
]);

/**
 * @generated from enum khulnasoft.v1.BranchMatchingStrategy
 */
...
proto3.util.setEnumType(BranchMatchingStrategy, "khulnasoft.v1.BranchMatchingStrategy", [
...
/**
 * @generated from message khulnasoft.v1.Configuration
 */
export class Configuration extends Message<Configuration> {
  ...
  /**
   * @generated from field: khulnasoft.v1.PrebuildSettings prebuild_settings = 6;
   */
  prebuildSettings?: PrebuildSettings;

  /**
   * @generated from field: khulnasoft.v1.WorkspaceSettings workspace_settings = 7;
   */
  ...
  static readonly typeName = "khulnasoft.v1.Configuration";
...
/**
 * @generated from message khulnasoft.v1.PrebuildSettings
 */
export class PrebuildSettings extends Message<PrebuildSettings> {
  ...
  /**
   * @generated from field: khulnasoft.v1.BranchMatchingStrategy branch_strategy = 3;
   */
  ...
  /**
   * @generated from field: khulnasoft.v1.PrebuildTriggerStrategy trigger_strategy = 6;
   */
  triggerStrategy = PrebuildTriggerStrategy.UNSPECIFIED;

  /**
   * @generated from field: khulnasoft.v1.PrebuildCloneSettings clone_settings = 7;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.PrebuildSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.PrebuildCloneSettings
 */
export class PrebuildCloneSettings extends Message<PrebuildCloneSettings> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.PrebuildCloneSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.WorkspaceSettings
 */
export class WorkspaceSettings extends Message<WorkspaceSettings> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.WorkspaceSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.CreateConfigurationRequest
 */
export class CreateConfigurationRequest extends Message<CreateConfigurationRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.CreateConfigurationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.CreateConfigurationResponse
 */
export class CreateConfigurationResponse extends Message<CreateConfigurationResponse> {
  /**
   * @generated from field: khulnasoft.v1.Configuration configuration = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.CreateConfigurationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.GetConfigurationRequest
 */
export class GetConfigurationRequest extends Message<GetConfigurationRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.GetConfigurationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.GetConfigurationResponse
 */
export class GetConfigurationResponse extends Message<GetConfigurationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.GetConfigurationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "configuration", kind: "message", T: Configuration },
  ]);
...
/**
 * @generated from message khulnasoft.v1.ListConfigurationsRequest
 */
export class ListConfigurationsRequest extends Message<ListConfigurationsRequest> {
  ...
  /**
   * @generated from field: khulnasoft.v1.PaginationRequest pagination = 3;
   */
   ...
   *
   * @generated from field: repeated khulnasoft.v1.Sort sort = 4;
   */
  sort: Sort[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.ListConfigurationsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "organization_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message khulnasoft.v1.ListConfigurationsResponse
 */
export class ListConfigurationsResponse extends Message<ListConfigurationsResponse> {
  /**
   * @generated from field: repeated khulnasoft.v1.Configuration configurations = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.ListConfigurationsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.UpdateConfigurationRequest
 */
export class UpdateConfigurationRequest extends Message<UpdateConfigurationRequest> {
  ...
  /**
   * @generated from field: optional khulnasoft.v1.UpdateConfigurationRequest.PrebuildSettings prebuild_settings = 3;
   */
  prebuildSettings?: UpdateConfigurationRequest_PrebuildSettings;

  /**
   * @generated from field: optional khulnasoft.v1.UpdateConfigurationRequest.WorkspaceSettings workspace_settings = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.UpdateConfigurationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "configuration_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message khulnasoft.v1.UpdateConfigurationRequest.PrebuildSettings
 */
export class UpdateConfigurationRequest_PrebuildSettings extends Message<UpdateConfigurationRequest_PrebuildSettings> {
  ...
  /**
   * @generated from field: optional khulnasoft.v1.BranchMatchingStrategy branch_strategy = 3;
   */
  ...
  /**
   * @generated from field: optional khulnasoft.v1.PrebuildTriggerStrategy trigger_strategy = 6;
   */
  triggerStrategy?: PrebuildTriggerStrategy;

  /**
   * @generated from field: optional khulnasoft.v1.PrebuildCloneSettings clone_settings = 7;
   */
  cloneSettings?: PrebuildCloneSettings;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.UpdateConfigurationRequest.PrebuildSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.UpdateConfigurationRequest.WorkspaceSettings
 */
export class UpdateConfigurationRequest_WorkspaceSettings extends Message<UpdateConfigurationRequest_WorkspaceSettings> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.UpdateConfigurationRequest.WorkspaceSettings";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.UpdateConfigurationResponse
 */
export class UpdateConfigurationResponse extends Message<UpdateConfigurationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.UpdateConfigurationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "configuration", kind: "message", T: Configuration },
  ]);
...
/**
 * @generated from message khulnasoft.v1.DeleteConfigurationRequest
 */
export class DeleteConfigurationRequest extends Message<DeleteConfigurationRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.DeleteConfigurationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "configuration_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message khulnasoft.v1.DeleteConfigurationResponse
 */
export class DeleteConfigurationResponse extends Message<DeleteConfigurationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.DeleteConfigurationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
