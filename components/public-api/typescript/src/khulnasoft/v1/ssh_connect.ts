...
/**
 * @generated from service khulnasoft.v1.SSHService
 */
export const SSHService = {
  typeName: "khulnasoft.v1.SSHService",
  methods: {
    /**
     * ListSSHPublicKeys returns all the ssh public keys for the
     * authenticated user.
     *
     * @generated from rpc khulnasoft.v1.SSHService.ListSSHPublicKeys
     */
    listSSHPublicKeys: {
     ...
     * authenticated user.
     *
     * @generated from rpc khulnasoft.v1.SSHService.CreateSSHPublicKey
     */
    createSSHPublicKey: {
     ...
     * authenticated user.
     *
     * @generated from rpc khulnasoft.v1.SSHService.DeleteSSHPublicKey
     */
    deleteSSHPublicKey: {
