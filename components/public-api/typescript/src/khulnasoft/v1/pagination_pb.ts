...
// @generated from file khulnasoft/v1/pagination.proto (package khulnasoft.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message khulnasoft.v1.PaginationRequest
 */
export class PaginationRequest extends Message<PaginationRequest> {
  ...
  static readonly typeName = "khulnasoft.v1.PaginationRequest";
...
/**
 * @generated from message khulnasoft.v1.PaginationResponse
 */
export class PaginationResponse extends Message<PaginationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.PaginationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
