...
// @generated from file khulnasoft/v1/editor.proto (package khulnasoft.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message khulnasoft.v1.EditorReference
 */
export class EditorReference extends Message<EditorReference> {
  ...
  static readonly typeName = "khulnasoft.v1.EditorReference";
