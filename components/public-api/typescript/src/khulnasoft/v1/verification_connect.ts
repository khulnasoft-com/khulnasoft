...
/**
 * @generated from service khulnasoft.v1.VerificationService
 */
export const VerificationService = {
  typeName: "khulnasoft.v1.VerificationService",
  methods: {
    /**
     * SendPhoneNumberVerificationToken sends a verification token to the
     * specified phone number.
     *
     * @generated from rpc khulnasoft.v1.VerificationService.SendPhoneNumberVerificationToken
     */
     ...
     * token.
     *
     * @generated from rpc khulnasoft.v1.VerificationService.VerifyPhoneNumberVerificationToken
     */
