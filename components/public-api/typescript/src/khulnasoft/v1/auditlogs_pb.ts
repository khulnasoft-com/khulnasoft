...
/**
 * @generated from message khulnasoft.v1.ListAuditLogsRequest
 */
export class ListAuditLogsRequest extends Message<ListAuditLogsRequest> {
  ...
  static readonly typeName = "khulnasoft.v1.ListAuditLogsRequest";
...
/**
 * @generated from message khulnasoft.v1.ListAuditLogsResponse
 */
export class ListAuditLogsResponse extends Message<ListAuditLogsResponse> {
   ...
   *
   * @generated from field: repeated khulnasoft.v1.AuditLog audit_logs = 2;
   */
  auditLogs: AuditLog[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.ListAuditLogsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * typescript shape:
 *
 * @generated from message khulnasoft.v1.AuditLog
 */
export class AuditLog extends Message<AuditLog> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.AuditLog";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
