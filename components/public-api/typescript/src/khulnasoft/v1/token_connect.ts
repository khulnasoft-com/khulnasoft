...
/**
 * @generated from service khulnasoft.v1.TokenService
 */
export const TokenService = {
  typeName: "khulnasoft.v1.TokenService",
  methods: {
    /**
     * CreateUserToken creates a new temporary access token for the specified user.
     * +admin – only to be used by installation admins
     *
     * @generated from rpc khulnasoft.v1.TokenService.CreateTemporaryAccessToken
     */
