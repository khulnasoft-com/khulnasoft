...
// @generated from file khulnasoft/v1/error.proto (package khulnasoft.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message khulnasoft.v1.PermissionDeniedDetails
 */
export class PermissionDeniedDetails extends Message<PermissionDeniedDetails> {
  /**
   * @generated from oneof khulnasoft.v1.PermissionDeniedDetails.reason
   */
  reason: {
    /**
     * @generated from field: khulnasoft.v1.UserBlockedError user_blocked = 1;
     */
    value: UserBlockedError;
    case: "userBlocked";
  } | {
    /**
     * @generated from field: khulnasoft.v1.NeedsVerificationError needs_verification = 2;
     */
  ...
  static readonly typeName = "khulnasoft.v1.PermissionDeniedDetails";
...
/**
 * @generated from message khulnasoft.v1.UserBlockedError
 */
export class UserBlockedError extends Message<UserBlockedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.UserBlockedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message khulnasoft.v1.NeedsVerificationError
 */
export class NeedsVerificationError extends Message<NeedsVerificationError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.NeedsVerificationError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message khulnasoft.v1.FailedPreconditionDetails
 */
export class FailedPreconditionDetails extends Message<FailedPreconditionDetails> {
  /**
   * @generated from oneof khulnasoft.v1.FailedPreconditionDetails.reason
   */
  reason: {
    /**
     * @generated from field: khulnasoft.v1.PaymentSpendingLimitReachedError payment_spending_limit_reached = 1;
     */
    value: PaymentSpendingLimitReachedError;
    case: "paymentSpendingLimitReached";
  } | {
    /**
     * @generated from field: khulnasoft.v1.InvalidCostCenterError invalid_cost_center = 2;
     */
    value: InvalidCostCenterError;
    case: "invalidCostCenter";
  } | {
    /**
     * @generated from field: khulnasoft.v1.TooManyRunningWorkspacesError too_many_running_workspaces = 3;
     */
    value: TooManyRunningWorkspacesError;
    case: "tooManyRunningWorkspaces";
  } | {
    /**
     * @generated from field: khulnasoft.v1.InvalidKhulnasoftYMLError invalid_khulnasoft_yml = 4;
     */
    value: InvalidKhulnasoftYMLError;
    case: "invalidKhulnasoftYml";
  } | {
    /**
     * @generated from field: khulnasoft.v1.RepositoryNotFoundError repository_not_found = 5;
     */
    value: RepositoryNotFoundError;
    case: "repositoryNotFound";
  } | {
    /**
     * @generated from field: khulnasoft.v1.RepositoryUnauthorizedError repository_unauthorized = 6;
     */
    value: RepositoryUnauthorizedError;
    case: "repositoryUnauthorized";
  } | {
    /**
     * @generated from field: khulnasoft.v1.ImageBuildLogsNotYetAvailableError image_build_logs_not_yet_available = 7;
     */
    value: ImageBuildLogsNotYetAvailableError;
    case: "imageBuildLogsNotYetAvailable";
  } | {
    /**
     * @generated from field: khulnasoft.v1.CellDisabledError cell_is_disabled = 8;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.FailedPreconditionDetails";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "invalid_khulnasoft_yml", kind: "message", T: InvalidKhulnasoftYMLError, oneof: "reason" },
...
/**
 * @generated from message khulnasoft.v1.PaymentSpendingLimitReachedError
 */
export class PaymentSpendingLimitReachedError extends Message<PaymentSpendingLimitReachedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.PaymentSpendingLimitReachedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message khulnasoft.v1.InvalidCostCenterError
 */
export class InvalidCostCenterError extends Message<InvalidCostCenterError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.InvalidCostCenterError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.TooManyRunningWorkspacesError
 */
export class TooManyRunningWorkspacesError extends Message<TooManyRunningWorkspacesError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.TooManyRunningWorkspacesError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message khulnasoft.v1.InvalidKhulnasoftYMLError
 */
export class InvalidKhulnasoftYMLError extends Message<InvalidKhulnasoftYMLError> {
  /**
   * @generated from field: repeated string violations = 1;
   */
  violations: string[] = [];

  constructor(data?: PartialMessage<InvalidKhulnasoftYMLError>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.InvalidKhulnasoftYMLError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "violations", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): InvalidKhulnasoftYMLError {
    return new InvalidKhulnasoftYMLError().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): InvalidKhulnasoftYMLError {
    return new InvalidKhulnasoftYMLError().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): InvalidKhulnasoftYMLError {
    return new InvalidKhulnasoftYMLError().fromJsonString(jsonString, options);
  }

  static equals(a: InvalidKhulnasoftYMLError | PlainMessage<InvalidKhulnasoftYMLError> | undefined, b: InvalidKhulnasoftYMLError | PlainMessage<InvalidKhulnasoftYMLError> | undefined): boolean {
    return proto3.util.equals(InvalidKhulnasoftYMLError, a, b);
  }
}

/**
 * @generated from message khulnasoft.v1.RepositoryNotFoundError
 */
export class RepositoryNotFoundError extends Message<RepositoryNotFoundError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.RepositoryNotFoundError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message khulnasoft.v1.RepositoryUnauthorizedError
 */
export class RepositoryUnauthorizedError extends Message<RepositoryUnauthorizedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.RepositoryUnauthorizedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "host", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message khulnasoft.v1.ImageBuildLogsNotYetAvailableError
 */
export class ImageBuildLogsNotYetAvailableError extends Message<ImageBuildLogsNotYetAvailableError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.ImageBuildLogsNotYetAvailableError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message khulnasoft.v1.CellDisabledError
 */
export class CellDisabledError extends Message<CellDisabledError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.v1.CellDisabledError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
