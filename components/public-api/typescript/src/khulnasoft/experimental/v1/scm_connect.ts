...
/**
 * @generated from service khulnasoft.experimental.v1.SCMService
 */
export const SCMService = {
  typeName: "khulnasoft.experimental.v1.SCMService",
  methods: {
    /**
     * GetSuggestedRepoURLs returns a list of suggested repositories to open for
     * the user.
     *
     * @generated from rpc khulnasoft.experimental.v1.SCMService.GetSuggestedRepoURLs
     */
