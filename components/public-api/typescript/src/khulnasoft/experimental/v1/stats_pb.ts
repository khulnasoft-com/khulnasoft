...
// @generated from file khulnasoft/experimental/v1/stats.proto (package khulnasoft.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message khulnasoft.experimental.v1.GetUserStatsRequest
 */
export class GetUserStatsRequest extends Message<GetUserStatsRequest> {
  ...
  static readonly typeName = "khulnasoft.experimental.v1.GetUserStatsRequest";
...
/**
 * @generated from message khulnasoft.experimental.v1.GetUserStatsResponse
 */
export class GetUserStatsResponse extends Message<GetUserStatsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.experimental.v1.GetUserStatsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
