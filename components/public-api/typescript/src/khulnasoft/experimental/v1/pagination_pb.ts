...
// @generated from file khulnasoft/experimental/v1/pagination.proto (package khulnasoft.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message khulnasoft.experimental.v1.Pagination
 */
export class Pagination extends Message<Pagination> {
  ...
  static readonly typeName = "khulnasoft.experimental.v1.Pagination";
