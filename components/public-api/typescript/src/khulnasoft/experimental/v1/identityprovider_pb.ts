...
// @generated from file khulnasoft/experimental/v1/identityprovider.proto (package khulnasoft.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message khulnasoft.experimental.v1.GetIDTokenRequest
 */
export class GetIDTokenRequest extends Message<GetIDTokenRequest> {
  ...
  static readonly typeName = "khulnasoft.experimental.v1.GetIDTokenRequest";
...
/**
 * @generated from message khulnasoft.experimental.v1.GetIDTokenResponse
 */
export class GetIDTokenResponse extends Message<GetIDTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "khulnasoft.experimental.v1.GetIDTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
