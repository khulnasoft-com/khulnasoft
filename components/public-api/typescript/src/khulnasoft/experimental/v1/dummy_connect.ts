 ...
 * testing.
 *
 * @generated from service khulnasoft.experimental.v1.HelloService
 */
export const HelloService = {
  typeName: "khulnasoft.experimental.v1.HelloService",
  methods: {
    /**
     ...
     *
     * @generated from rpc khulnasoft.experimental.v1.HelloService.SayHello
     */
    sayHello: {
      name: "SayHello",
      I: SayHelloRequest,
     ...
     *
     * @generated from rpc khulnasoft.experimental.v1.HelloService.LotsOfReplies
     */
    lotsOfReplies: {
      name: "LotsOfReplies",
