...
import { User as UserProtocol } from "@khulnasoft/khulnasoft-protocol/lib/protocol";
...
/**
 * khulnasoft.com: Only installation-level users are allowed to create orgs (installation-level users on khulnasoft.com, and admin user on Dedicated)
