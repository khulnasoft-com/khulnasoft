...
const (
	...
	StatsServiceName = "khulnasoft.experimental.v1.StatsService"
)

// StatsServiceClient is a client for the khulnasoft.experimental.v1.StatsService service.
...
// NewStatsServiceClient constructs a client for the khulnasoft.experimental.v1.StatsService service. By
...
func NewStatsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) StatsServiceClient {
	...
	return &statsServiceClient{
		getUserStats: connect_go.NewClient[v1.GetUserStatsRequest, v1.GetUserStatsResponse](
			httpClient,
			baseURL+"/khulnasoft.experimental.v1.StatsService/GetUserStats",
			opts...,
		),
	}
}
...
// GetUserStats calls khulnasoft.experimental.v1.StatsService.GetUserStats.
...
// StatsServiceHandler is an implementation of the khulnasoft.experimental.v1.StatsService service.
...
func NewStatsServiceHandler(svc StatsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/khulnasoft.experimental.v1.StatsService/GetUserStats", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.StatsService/GetUserStats",
		svc.GetUserStats,
		opts...,
	))
	return "/khulnasoft.experimental.v1.StatsService/", mux
}
...
func (UnimplementedStatsServiceHandler) GetUserStats(context.Context, *connect_go.Request[v1.GetUserStatsRequest]) (*connect_go.Response[v1.GetUserStatsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.StatsService.GetUserStats is not implemented"))
}
