...
const (
	...
	ProjectsServiceName = "khulnasoft.experimental.v1.ProjectsService"
)

// ProjectsServiceClient is a client for the khulnasoft.experimental.v1.ProjectsService service.
...
// NewProjectsServiceClient constructs a client for the khulnasoft.experimental.v1.ProjectsService
...
func NewProjectsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) ProjectsServiceClient {
	...
	return &projectsServiceClient{
		createProject: connect_go.NewClient[v1.CreateProjectRequest, v1.CreateProjectResponse](
			httpClient,
			baseURL+"/khulnasoft.experimental.v1.ProjectsService/CreateProject",
			opts...,
		),
		getProject: connect_go.NewClient[v1.GetProjectRequest, v1.GetProjectResponse](
			httpClient,
			baseURL+"/khulnasoft.experimental.v1.ProjectsService/GetProject",
			opts...,
		),
		listProjects: connect_go.NewClient[v1.ListProjectsRequest, v1.ListProjectsResponse](
			httpClient,
			baseURL+"/khulnasoft.experimental.v1.ProjectsService/ListProjects",
			opts...,
		),
		deleteProject: connect_go.NewClient[v1.DeleteProjectRequest, v1.DeleteProjectResponse](
			httpClient,
			baseURL+"/khulnasoft.experimental.v1.ProjectsService/DeleteProject",
			opts...,
		),
	}
}
...
// CreateProject calls khulnasoft.experimental.v1.ProjectsService.CreateProject.
...
// GetProject calls khulnasoft.experimental.v1.ProjectsService.GetProject.
...
// ListProjects calls khulnasoft.experimental.v1.ProjectsService.ListProjects.
...
// DeleteProject calls khulnasoft.experimental.v1.ProjectsService.DeleteProject.
...
// ProjectsServiceHandler is an implementation of the khulnasoft.experimental.v1.ProjectsService
// service.
...
func NewProjectsServiceHandler(svc ProjectsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/khulnasoft.experimental.v1.ProjectsService/CreateProject", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.ProjectsService/CreateProject",
		svc.CreateProject,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.ProjectsService/GetProject", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.ProjectsService/GetProject",
		svc.GetProject,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.ProjectsService/ListProjects", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.ProjectsService/ListProjects",
		svc.ListProjects,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.ProjectsService/DeleteProject", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.ProjectsService/DeleteProject",
		svc.DeleteProject,
		opts...,
	))
	return "/khulnasoft.experimental.v1.ProjectsService/", mux
}
...
func (UnimplementedProjectsServiceHandler) CreateProject(context.Context, *connect_go.Request[v1.CreateProjectRequest]) (*connect_go.Response[v1.CreateProjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.ProjectsService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectsServiceHandler) GetProject(context.Context, *connect_go.Request[v1.GetProjectRequest]) (*connect_go.Response[v1.GetProjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.ProjectsService.GetProject is not implemented"))
}
...
func (UnimplementedProjectsServiceHandler) ListProjects(context.Context, *connect_go.Request[v1.ListProjectsRequest]) (*connect_go.Response[v1.ListProjectsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.ProjectsService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectsServiceHandler) DeleteProject(context.Context, *connect_go.Request[v1.DeleteProjectRequest]) (*connect_go.Response[v1.DeleteProjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.ProjectsService.DeleteProject is not implemented"))
}
