...
const (
	...
	IdentityProviderServiceName = "khulnasoft.experimental.v1.IdentityProviderService"
)

// IdentityProviderServiceClient is a client for the khulnasoft.experimental.v1.IdentityProviderService
// service.
...
// khulnasoft.experimental.v1.IdentityProviderService service. By default, it uses the Connect protocol
...
func NewIdentityProviderServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) IdentityProviderServiceClient {
	...
	return &identityProviderServiceClient{
		getIDToken: connect_go.NewClient[v1.GetIDTokenRequest, v1.GetIDTokenResponse](
			httpClient,
			baseURL+"/khulnasoft.experimental.v1.IdentityProviderService/GetIDToken",
			opts...,
		),
	}
}
...
// GetIDToken calls khulnasoft.experimental.v1.IdentityProviderService.GetIDToken.
...
// khulnasoft.experimental.v1.IdentityProviderService service.
...
func NewIdentityProviderServiceHandler(svc IdentityProviderServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/khulnasoft.experimental.v1.IdentityProviderService/GetIDToken", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.IdentityProviderService/GetIDToken",
		svc.GetIDToken,
		opts...,
	))
	return "/khulnasoft.experimental.v1.IdentityProviderService/", mux
}
...
func (UnimplementedIdentityProviderServiceHandler) GetIDToken(context.Context, *connect_go.Request[v1.GetIDTokenRequest]) (*connect_go.Response[v1.GetIDTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.IdentityProviderService.GetIDToken is not implemented"))
}
