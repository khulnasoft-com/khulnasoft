...
const (
	...
	OIDCServiceName = "khulnasoft.experimental.v1.OIDCService"
)

// OIDCServiceClient is a client for the khulnasoft.experimental.v1.OIDCService service.
...
// NewOIDCServiceClient constructs a client for the khulnasoft.experimental.v1.OIDCService service. By
...
// CreateClientConfig calls khulnasoft.experimental.v1.OIDCService.CreateClientConfig.
...
// GetClientConfig calls khulnasoft.experimental.v1.OIDCService.GetClientConfig.
...
// ListClientConfigs calls khulnasoft.experimental.v1.OIDCService.ListClientConfigs.
...
// UpdateClientConfig calls khulnasoft.experimental.v1.OIDCService.UpdateClientConfig.
...
// DeleteClientConfig calls khulnasoft.experimental.v1.OIDCService.DeleteClientConfig.
...
// SetClientConfigActivation calls khulnasoft.experimental.v1.OIDCService.SetClientConfigActivation.
...
// OIDCServiceHandler is an implementation of the khulnasoft.experimental.v1.OIDCService service.
...
func NewOIDCServiceHandler(svc OIDCServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/khulnasoft.experimental.v1.OIDCService/CreateClientConfig", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.OIDCService/CreateClientConfig",
		svc.CreateClientConfig,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.OIDCService/GetClientConfig", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.OIDCService/GetClientConfig",
		svc.GetClientConfig,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.OIDCService/ListClientConfigs", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.OIDCService/ListClientConfigs",
		svc.ListClientConfigs,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.OIDCService/UpdateClientConfig", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.OIDCService/UpdateClientConfig",
		svc.UpdateClientConfig,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.OIDCService/DeleteClientConfig", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.OIDCService/DeleteClientConfig",
		svc.DeleteClientConfig,
		opts...,
	))
	mux.Handle("/khulnasoft.experimental.v1.OIDCService/SetClientConfigActivation", connect_go.NewUnaryHandler(
		"/khulnasoft.experimental.v1.OIDCService/SetClientConfigActivation",
		svc.SetClientConfigActivation,
		opts...,
	))
	return "/khulnasoft.experimental.v1.OIDCService/", mux
}
...
func (UnimplementedOIDCServiceHandler) CreateClientConfig(context.Context, *connect_go.Request[v1.CreateClientConfigRequest]) (*connect_go.Response[v1.CreateClientConfigResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.OIDCService.CreateClientConfig is not implemented"))
}
...
func (UnimplementedOIDCServiceHandler) GetClientConfig(context.Context, *connect_go.Request[v1.GetClientConfigRequest]) (*connect_go.Response[v1.GetClientConfigResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.OIDCService.GetClientConfig is not implemented"))
}
...
func (UnimplementedOIDCServiceHandler) ListClientConfigs(context.Context, *connect_go.Request[v1.ListClientConfigsRequest]) (*connect_go.Response[v1.ListClientConfigsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.OIDCService.ListClientConfigs is not implemented"))
}
...
func (UnimplementedOIDCServiceHandler) UpdateClientConfig(context.Context, *connect_go.Request[v1.UpdateClientConfigRequest]) (*connect_go.Response[v1.UpdateClientConfigResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.OIDCService.UpdateClientConfig is not implemented"))
}
...
func (UnimplementedOIDCServiceHandler) DeleteClientConfig(context.Context, *connect_go.Request[v1.DeleteClientConfigRequest]) (*connect_go.Response[v1.DeleteClientConfigResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.OIDCService.DeleteClientConfig is not implemented"))
}
...
func (UnimplementedOIDCServiceHandler) SetClientConfigActivation(context.Context, *connect_go.Request[v1.SetClientConfigActivationRequest]) (*connect_go.Response[v1.SetClientConfigActivationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("khulnasoft.experimental.v1.OIDCService.SetClientConfigActivation is not implemented"))
}
