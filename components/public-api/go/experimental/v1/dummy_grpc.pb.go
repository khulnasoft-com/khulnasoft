...
func (c *helloServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/khulnasoft.experimental.v1.HelloService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) LotsOfReplies(ctx context.Context, in *LotsOfRepliesRequest, opts ...grpc.CallOption) (HelloService_LotsOfRepliesClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], "/khulnasoft.experimental.v1.HelloService/LotsOfReplies", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/khulnasoft.experimental.v1.HelloService/SayHello",
	}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "khulnasoft.experimental.v1.HelloService",
	...
	Metadata: "khulnasoft/experimental/v1/dummy.proto",
}
