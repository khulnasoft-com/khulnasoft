...
> Once completed, [#7845](https://github.com/khulnasoft-com/khulnasoft/issues/7845) will move `image-builder-mk3` (and image builds) from meta to workspace clusters.

The following diagram shows what happens during a workspace image build. See the (internal) [Architecture page](https://www.notion.so/khulnasoft/Architecture-0e39e570b10f4e8ba7b259629ee3cb74) for more details.
...
```console
cd /workspace/khulnasoft/components/image-builder-mk3
...
grpcurl -plaintext -proto /workspace/khulnasoft/components/image-builder-api/imgbuilder.proto -import-path=/workspace/khulnasoft/components/ localhost:8080 builder.ImageBuilder.ListBuilds
```
