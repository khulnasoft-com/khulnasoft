...
const (
	workspaceDownloadModule = "khulnasoft.workspace_download"
)
...
// Download implements an HTTP handler that extracts khulnasoft headers
...
func (Download) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.khulnasoft_workspace_download",
