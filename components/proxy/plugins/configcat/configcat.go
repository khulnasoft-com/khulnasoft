...
const (
	configCatModule = "khulnasoft.configcat"
)

var (
	DefaultConfig = []byte("{}")
	pathRegex     = regexp.MustCompile(`^/configcat/configuration-files/khulnasoft/config_v\d+\.json$`)
)
...
func (ConfigCat) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.khulnasoft_configcat",
