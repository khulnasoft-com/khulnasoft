...
const (
	headlessLogDownloadModule = "khulnasoft.headless_log_download"
)
...
// HeadlessLogDownload implements an HTTP handler that extracts khulnasoft headers
...
func (HeadlessLogDownload) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.khulnasoft_headless_log_download",
