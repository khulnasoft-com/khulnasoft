	...
	}{
		{
			...
			args: args{
				...
				allowClient: &config.LabelAllowList{
					Name:         "khulnasoft",
					AllowValues:  []string{"awesome", "khulnasoft"},
					DefaultValue: "khulnasoft",
				},
			},
			want: &want{
				AllowLabelValues:        map[string][]string{"hello": {"world"}, "khulnasoft": {"awesome", "khulnasoft"}},
				AllowLabelDefaultValues: map[string]string{"khulnasoft": "khulnasoft"},
				ClientLabel:             "khulnasoft",
			},
		},
		{
