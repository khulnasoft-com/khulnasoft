...
// NewFromEnvironment creates a new error report instance based on the KHULNASOFT_ENABLED_ERROR_REPORTING
// environment variable. This function never returns nil
func NewFromEnvironment() ErrorReporter {
	isEnabled := os.Getenv("KHULNASOFT_ENABLED_ERROR_REPORTING") == "true"
	if !isEnabled {
