...
func parseKhulnasoftTimeStampOrDefault(s string) *timestamppb.Timestamp {
	parsed, err := parseKhulnasoftTimestamp(s)
	if err != nil {
...
func parseKhulnasoftTimestamp(input string) (*timestamppb.Timestamp, error) {
