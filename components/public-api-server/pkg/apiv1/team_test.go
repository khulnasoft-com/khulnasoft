...
func TestTeamToAPIResponse(t *testing.T) {
	...
	members := []*protocol.TeamMemberInfo{
		{
			...
			FullName:     "First Last",
			PrimaryEmail: "email1@khulnasoft.com",
		...
		},
		{
			...
			PrimaryEmail: "email2@khulnasoft.com",
	...
	invite := &protocol.TeamMembershipInvite{
		...
		InvitedEmail:     "nope@khulnasoft.com",
	}
		...
		Members: []*v1.TeamMember{
			{
				...
				MemberSince:  parseKhulnasoftTimeStampOrDefault(members[0].MemberSince),
			...
			},
			{
				...
				MemberSince:  parseKhulnasoftTimeStampOrDefault(members[1].MemberSince),
...
func newTeamMember(m *protocol.TeamMemberInfo) *protocol.TeamMemberInfo {
	result := &protocol.TeamMemberInfo{
		UserId:       uuid.New().String(),
		FullName:     "First Last",
		PrimaryEmail: "email@khulnasoft.com",
