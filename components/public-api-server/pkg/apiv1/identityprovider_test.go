...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/common-go/experiments/experimentstest"
...
func TestGetIDToken(t *testing.T) {
	const workspaceID = "khulnasoftio-khulnasoft-te23l4bjejv"
					...
					&protocol.WorkspaceInfo{
						Workspace: &protocol.Workspace{
							...
							Context: &protocol.WorkspaceContext{
								...
								NormalizedContextURL: "https://github.com/khulnasoft-com/khulnasoft",
							},
						},
					},
					nil,
