...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/public-api-server/middleware"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/apiv1"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/auth"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/billingservice"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/identityprovider"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/jws"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/oidc"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/origin"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/proxy"
	"github.com/khulnasoft-com/khulnasoft/public-api-server/pkg/webhooks"
...
func Start(logger *logrus.Entry, version string, cfg *config.Configuration) error {
	...
	khulnasoftAPI, err := url.Parse(cfg.KhulnasoftServiceURL)
	if err != nil {
		return fmt.Errorf("failed to parse Khulnasoft API URL: %w", err)
	}

	connPool, err := proxy.NewConnectionPool(khulnasoftAPI, 500)
	if err != nil {
