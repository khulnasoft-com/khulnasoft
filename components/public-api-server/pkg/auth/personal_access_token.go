...
const PersonalAccessTokenPrefix = "khulnasoft_pat_"
...
// The PersonalAccessToken, in string form, takes the following shape: khulnasoft_pat_<signature>.<value>
// E.g. khulnasoft_pat_ko8KC1tJ-GkqIwqNliwF4tBUk2Jd5nEe9qOWqYfobtY.6ZDQVanpaTKj9hQuji0thCe8KFCcmEDGpsaTkSSb
...
func ParsePersonalAccessToken(token string, signer Signer) (PersonalAccessToken, error) {
	...
	// Assume we start with the following token: khulnasoft_pat_ko8KC1tJ-GkqIwqNliwF4tBUk2Jd5nEe9qOWqYfobtY.6ZDQVanpaTKj9hQuji0thCe8KFCcmEDGpsaTkSSb
	...
	// Remove the khulnasoft_pat_ prefix
