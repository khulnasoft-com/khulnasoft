module github.com/khulnasoft-com/khulnasoft/workspacekit

go 1.22.0

toolchain go1.23.3

replace github.com/seccomp/libseccomp-golang => github.com/khulnasoft-com/libseccomp-golang v0.9.2-0.20220701021458-9bf1c833815b
