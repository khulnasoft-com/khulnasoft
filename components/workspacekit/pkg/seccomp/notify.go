...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/workspacekit/pkg/readarg"
...
// InWorkspaceHandler is the seccomp notification handler that serves a Khulnasoft workspace
