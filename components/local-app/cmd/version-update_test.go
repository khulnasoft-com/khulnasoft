	...
	RunCommandTests(t, []CommandTest{
		{
			...
			PrepServer: func(mux *http.ServeMux) {
				...
				mux.HandleFunc(selfupdate.KhulnasoftCLIBasePath+"/manifest.json", func(w http.ResponseWriter, r *http.Request) {
				...
				mux.HandleFunc(selfupdate.KhulnasoftCLIBasePath+"/khulnasoft", func(w http.ResponseWriter, r *http.Request) {
