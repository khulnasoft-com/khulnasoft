	...
	RunCommandTests(t, []CommandTest{
		...
		},
		{
			...
			PrepServer: func(mux *http.ServeMux) {
				mux.Handle(khulnasoft_experimental_v1connect.NewWorkspacesServiceHandler(&testWorkspaceListCmdWorkspaceSrv{
...
type testWorkspaceListCmdWorkspaceSrv struct {
	Resp *v1.ListWorkspacesResponse
	Err  error
	khulnasoft_experimental_v1connect.UnimplementedWorkspacesServiceHandler
}
