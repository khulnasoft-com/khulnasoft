...
Example:
  # Disable telemetry
  khulnasoft config set --telemetry=false

  # Disable autoupdate
  khulnasoft config set --autoupdate=false

  # Enable telemetry and autoupdate
  khulnasoft config set --telemetry=true --autoupdate=true

  # Set your current context's organization
  khulnasoft config set --organization-id=your-org-id
`,
