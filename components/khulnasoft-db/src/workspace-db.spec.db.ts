...
import { WorkspaceInstance, Workspace, PrebuiltWorkspace, CommitContext } from "@khulnasoft/khulnasoft-protocol";
...
class WorkspaceDBSpec {
    ...
    public async testCountUnabortedPrebuildsSince() {
        const now = new Date();
        const cloneURL = "https://github.com/khulnasoft-com/khulnasoft";
        const projectId = v4();
