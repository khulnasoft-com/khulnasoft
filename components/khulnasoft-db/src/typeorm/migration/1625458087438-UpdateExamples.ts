...
export class UpdateExamples1625458087438 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        const newEntries = [
            {
                url: "https://github.com/khulnasoft-com/template-typescript-node",
                description: "A Node.js app, written in TypeScript.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-typescript-react",
                description: "A create-react-app template, written in TypeScript.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-python-django",
                description: "A Django app template. ",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-python-flask",
            ...
            {
                url: "https://github.com/khulnasoft-com/template-php-drupal-ddev",
                description: "A Drupal app template, scaffolded by DDEV.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-php-laravel-mysql",
                description: "A Laravel app template, with MySQL.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-ruby-on-rails",
                description: "A Ruby on Rails app template, with Postgres. ",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-golang-cli",
                description: "A CLI template, written in Go.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-rust-cli",
                description: "A CLI template, written in Rust.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-dotnet-core-cli-csharp",
                description: "A CLI starter for .NET written in C#.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-sveltejs",
                description: "A Svelte.js app writtten in JavaScript.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-sveltejskit",
                description: "A SvelteKit app template.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-datasette",
                description: "A Datasette template.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-nix",
                description: "A nix template for reproducible development environments.",
                priority: priority--,
            },
            {
                url: "https://github.com/khulnasoft-com/template-haskell",
