...
import { getEnvVarParsed, getEnvVar } from "@khulnasoft/khulnasoft-protocol/lib/env";
...
export class Config {
    get dbConfig(): DatabaseConfig {
        ...
        const dbSetup: DatabaseConfig = {
            ...
            username: process.env.DB_USERNAME || "khulnasoft",
            password: process.env.DB_PASSWORD || "test",
            database: process.env.DB_NAME || "khulnasoft",
        };
