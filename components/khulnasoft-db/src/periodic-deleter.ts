...
import { KhulnasoftTableDescriptionProvider, TableDescription } from "./tables";
import { TypeORM } from "./typeorm/typeorm";

@injectable()
export class PeriodicDbDeleter {
    @inject(KhulnasoftTableDescriptionProvider) protected readonly tableProvider: KhulnasoftTableDescriptionProvider;
