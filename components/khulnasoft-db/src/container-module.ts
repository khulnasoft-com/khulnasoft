...
import { encryptionModule } from "@khulnasoft/khulnasoft-protocol/lib/encryption/container-module";
import { KeyProviderImpl, KeyProviderConfig } from "@khulnasoft/khulnasoft-protocol/lib/encryption/key-provider";
...
import { KhulnasoftTableDescriptionProvider, TableDescriptionProvider } from "./tables";
...
import { TracingManager } from "@khulnasoft/khulnasoft-protocol/lib/util/tracing";
import { EncryptionService, GlobalEncryptionService } from "@khulnasoft/khulnasoft-protocol/lib/encryption/encryption-service";
...
export const dbContainerModule = (cacheClass = DataCacheNoop) =>
    new ContainerModule((bind, unbind, isBound, rebind, unbindAsync, onActivation, onDeactivation) => {
        ...
        bind(KhulnasoftTableDescriptionProvider).toSelf().inSingletonScope();
        bind(TableDescriptionProvider).toService(KhulnasoftTableDescriptionProvider);
