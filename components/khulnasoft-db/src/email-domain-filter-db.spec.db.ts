...
export class EmailDomainFilterDBSpec {
    ...
    @test public async filterSimple() {
        ...
        const actual = await this.db.isBlocked("khulnasoft.com");
    ...
    @test public async filterSimple_negative() {
        ...
        const actual2 = await this.db.isBlocked("sub.khulnasoft.com");
    ...
    @test public async filterSuffixMatch() {
        ...
        const actual3 = await this.db.isBlocked("sub.khulnasoft.com.xyz");
