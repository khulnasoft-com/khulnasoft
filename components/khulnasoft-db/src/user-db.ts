...
export interface UserDB extends OAuthUserRepository, OAuthTokenRepository, TransactionalDB<UserDB> {
    ...
    findUserByKhulnasoftToken(
        tokenHash: string,
        tokenType?: KhulnasoftTokenType,
    ): Promise<{ user: User; token: KhulnasoftToken } | undefined>;
    findKhulnasoftTokensOfUser(userId: string, tokenHash: string): Promise<KhulnasoftToken | undefined>;
    findAllKhulnasoftTokensOfUser(userId: string): Promise<KhulnasoftToken[]>;
    storeKhulnasoftToken(token: KhulnasoftToken): Promise<void>;
    deleteKhulnasoftToken(tokenHash: string): Promise<void>;
    deleteKhulnasoftTokensNamedLike(userId: string, namePattern: string): Promise<void>;
