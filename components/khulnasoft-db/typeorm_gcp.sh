...
#            --env GCP_DATABASE="khulnasoft-foobar:europe-west1:khulnasoft-foobar-baz" \
#            --env DB_PASSWORD="..." \
#            gcr.io/khulnasoft-core-dev/build/db-migrations:x1 /app/typeorm_gcp.sh migrations:run
