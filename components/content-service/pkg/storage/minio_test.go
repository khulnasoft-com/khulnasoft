...
import (
	...
	config "github.com/khulnasoft-com/khulnasoft/content-service/api/config"
)
...
func TestMinioBucketName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ExpectedBucket:   "khulnasoft-user-fake-owner-id",
		},
		{
...
func TestMinioBackupObject(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			BucketNameConfig:     "",
			Username:             "test-user",
			Workspace:            "khulnasoftio-khulnasoft-2cx8z8e643x",
			InstanceID:           "fa9aa2af-b6de-45fc-8b48-534bb440429f",
			ObjectName:           "backup.tar",
			ExpectedBackupObject: "workspaces/khulnasoftio-khulnasoft-2cx8z8e643x/backup.tar",
		},
		{
			Name:                 "with dedicated bucket",
			BucketNameConfig:     "root-bucket",
			...
			InstanceID:           "fa9aa2af-b6de-45fc-8b48-534bb440429f",
			ObjectName:           "backup.tar",
			ExpectedBackupObject: "test-user/workspaces/khulnasoftio-khulnasoft-2cx8z8e643x/backup.tar",
		},
	}
