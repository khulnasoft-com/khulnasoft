...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/content-service/api/config"
	"github.com/khulnasoft-com/khulnasoft/content-service/pkg/executor"
	"github.com/khulnasoft-com/khulnasoft/content-service/pkg/initializer"
...
func contentDescriptorToLayer(cdesc []byte) (*Layer, error) {
	return layerFromContent(
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace", Uid: initializer.KhulnasoftUID, Gid: initializer.KhulnasoftGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace/.khulnasoft", Uid: initializer.KhulnasoftUID, Gid: initializer.KhulnasoftGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeReg, Name: "/workspace/.khulnasoft/content.json", Uid: initializer.KhulnasoftUID, Gid: initializer.KhulnasoftGID, Mode: 0755, Size: int64(len(cdesc))}, cdesc},
	)
}
...
func workspaceReadyLayer(src csapi.WorkspaceInitSource) (*Layer, error) {
	...
	return layerFromContent(
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace", Uid: initializer.KhulnasoftUID, Gid: initializer.KhulnasoftGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeDir, Name: "/workspace/.khulnasoft", Uid: initializer.KhulnasoftUID, Gid: initializer.KhulnasoftGID, Mode: 0755}, nil},
		fileInLayer{&tar.Header{Typeflag: tar.TypeReg, Name: "/workspace/.khulnasoft/ready", Uid: initializer.KhulnasoftUID, Gid: initializer.KhulnasoftGID, Mode: 0755, Size: int64(len(ctnt))}, []byte(ctnt)},
	)
}
