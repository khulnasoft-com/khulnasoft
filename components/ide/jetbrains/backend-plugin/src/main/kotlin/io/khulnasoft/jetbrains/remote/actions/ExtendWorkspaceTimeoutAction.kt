...
import io.khulnasoft.khulnasoftprotocol.api.entities.WorkspaceTimeoutDuration
...
// validation from https://github.com/khulnasoft-com/khulnasoft/blob/74ccaea38db8df2d1666161a073015485ebb90ca/components/khulnasoft-protocol/src/khulnasoft-service.ts#L361-L383
...
class ExtendWorkspaceTimeoutAction : AnAction() {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        manager.pendingInfo.thenAccept { workspaceInfo ->
            manager.trackEvent("jb_execute_command_khulnasoft_workspace", mapOf(
            ...
            if (dialog.showAndGet()) {
                ...
                manager.client.server.setWorkspaceTimeout(workspaceInfo.workspaceId, duration.toString()).whenComplete { result, e ->
                    ...
                    if (e != null) {
                        ...
                        thisLogger().error("khulnasoft: failed to extend workspace timeout", e)
                    } else {
