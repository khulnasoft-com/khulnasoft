...
<!-- Plugin description -->
Provides a way to connect to Khulnasoft workspaces.
...
This project is not Khulnasoftified yet because it requires running the JetBrains Gateway locally. For now, for development, contributors can use [IntelliJ IDEA](https://www.jetbrains.com/idea/) installed on their machines.
...
2. Open the terminal and run
    ...
    # jetbrains-gateway://connect#khulnasoftHost=khulnasoft.com&workspaceId=andreafalze-khulnasoftexper-4xasfqb42zr&backendPort=63342
    ```
3. Copy the output value
4. Go to your local terminal and run:
    ```console
    ./gradlew runIde --args="jetbrains-gateway://connect#khulnasoftHost=khulnasoft.com&workspaceId=andreafalze-khulnasoftexper-4xasfqb42zr&backendPort=63342"
    ```
...
- Download this Gateway Plugin build, from Khulnasoft's Plugin Dev Channel: https://plugins.jetbrains.com/plugin/18438-khulnasoft-gateway/versions/dev
...
- Check if changing the "Khulnasoft Host" in Preferences >> Tools >> Khulnasoft takes effect
