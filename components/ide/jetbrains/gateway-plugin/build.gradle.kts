...
project(":") {
    kotlin {
        ...
        sourceSets["main"].kotlin.exclude("io/khulnasoft/jetbrains/gateway/${excludedPackage}/**")
    }
...
intellijPlatform {
    ...
    publishing {
        ...
        var pluginChannels = providers.environmentVariable("JB_GATEWAY_KHULNASOFT_PLUGIN_CHANNEL").getOrElse("")
...
tasks.register("installPlugin") {
    ...
    doLast {
        val pluginTargetPath = "distributions/jetbrains-gateway-khulnasoft-plugin.zip"
