...
const (
	registryFacadeLabel = "khulnasoft.com/registry-facade_ready_ns_%v"
	wsdaemonLabel       = "khulnasoft.com/ws-daemon_ready_ns_%v"

	registryFacade = "registry-facade"
	wsDaemon       = "ws-daemon"

	// Taint keys for different components
	registryFacadeTaintKey = "khulnasoft.com/registry-facade-not-ready"
	wsDaemonTaintKey       = "khulnasoft.com/ws-daemon-not-ready"

	workspacesRegularLabel  = "khulnasoft.com/workload_workspace_regular"
	workspacesHeadlessLabel = "khulnasoft.com/workload_workspace_headless"
)
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
			...
			LeaderElection:   true,
			LeaderElectionID: "node-labeler.khulnasoft.com",
		})
		if err != nil {
