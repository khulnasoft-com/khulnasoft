...
//+kubebuilder:rbac:groups=workspace.khulnasoft.com,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=workspace.khulnasoft.com,resources=snapshots/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=workspace.khulnasoft.com,resources=snapshots/finalizers,verbs=update
