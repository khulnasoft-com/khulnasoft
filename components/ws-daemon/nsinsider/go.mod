module github.com/khulnasoft-com/khulnasoft/ws-daemon/nsinsider

go 1.22.0

toolchain go1.23.3

replace github.com/seccomp/libseccomp-golang => github.com/khulnasoft-com/libseccomp-golang v0.9.2-0.20220203100026-45179215fdb1 // blazedock indirect from components/workspacekit:lib
