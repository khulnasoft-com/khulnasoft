...
# Add khulnasoft user for operations (e.g. checkout because of the post-checkout hook!)
RUN groupadd -r -g 33333 khulnasoft \
  && useradd -r -u 33333 -md /home/khulnasoft -s /bin/bash -g khulnasoft khulnasoft \
  && usermod -a -G khulnasoft khulnasoft
...
COPY default.gitconfig /home/khulnasoft/.gitconfig
