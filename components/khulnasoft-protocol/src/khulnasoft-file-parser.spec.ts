...
import { KhulnasoftFileParser } from "./khulnasoft-file-parser";
...
@suite
class TestKhulnasoftFileParser {
    protected parser: KhulnasoftFileParser;

    public before() {
        this.parser = new KhulnasoftFileParser();
    }
...
module.exports = new TestKhulnasoftFileParser(); // Only to circumvent no usage warning :-/
