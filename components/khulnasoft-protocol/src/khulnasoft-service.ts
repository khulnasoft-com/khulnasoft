...
export interface KhulnasoftClient {
...
export const KhulnasoftServer = Symbol("KhulnasoftServer");
export interface KhulnasoftServer extends JsonRpcServer<KhulnasoftClient>, AdminServer, IDEServer {
    // User related API
    ...
    getToken(query: KhulnasoftServer.GetTokenSearchOptions): Promise<Token | undefined>;
    getKhulnasoftTokenScopes(tokenHash: string): Promise<string[]>;
    ...
    updateOwnAuthProvider(params: KhulnasoftServer.UpdateOwnAuthProviderParams): Promise<AuthProviderEntry>;
    deleteOwnAuthProvider(params: KhulnasoftServer.DeleteOwnAuthProviderParams): Promise<void>;
    // org-level
    createOrgAuthProvider(params: KhulnasoftServer.CreateOrgAuthProviderParams): Promise<AuthProviderEntry>;
    updateOrgAuthProvider(params: KhulnasoftServer.UpdateOrgAuthProviderParams): Promise<AuthProviderEntry>;
    getOrgAuthProviders(params: KhulnasoftServer.GetOrgAuthProviderParams): Promise<AuthProviderEntry[]>;
    deleteOrgAuthProvider(params: KhulnasoftServer.DeleteOrgAuthProviderParams): Promise<void>;
    ...
    getWorkspaces(options: KhulnasoftServer.GetWorkspacesOptions): Promise<WorkspaceInfo[]>;
     ...
     * @param options KhulnasoftServer.CreateWorkspaceOptions
     * @return WorkspaceCreationResult
     */
    createWorkspace(options: KhulnasoftServer.CreateWorkspaceOptions): Promise<WorkspaceCreationResult>;
    startWorkspace(id: string, options: KhulnasoftServer.StartWorkspaceOptions): Promise<StartWorkspaceResult>;
    stopWorkspace(id: string): Promise<void>;
    deleteWorkspace(id: string): Promise<void>;
    setWorkspaceDescription(id: string, desc: string): Promise<void>;
    controlAdmission(id: string, level: KhulnasoftServer.AdmissionLevel): Promise<void>;
    resolveContext(contextUrl: string): Promise<WorkspaceContext>;

    updateWorkspaceUserPin(id: string, action: KhulnasoftServer.PinAction): Promise<void>;
    sendHeartBeat(options: KhulnasoftServer.SendHeartBeatOptions): Promise<void>;
    ...
    getOnboardingState(): Promise<KhulnasoftServer.OnboardingState>;
    ...
    // Khulnasoft token
    getKhulnasoftTokens(): Promise<KhulnasoftToken[]>;
    generateNewKhulnasoftToken(options: KhulnasoftServer.GenerateNewKhulnasoftTokenOptions): Promise<string>;
    deleteKhulnasoftToken(tokenHash: string): Promise<void>;
     ...
     */
    takeSnapshot(options: KhulnasoftServer.TakeSnapshotOptions): Promise<string>;
    /**
     *
     * @param snapshotId
     */
...
export type DefaultImageSource =
    | "installation" // Source installation means the image comes from Khulnasoft instance install config
...
export const createServiceMock = function <C extends KhulnasoftClient, S extends KhulnasoftServer>(
    methods: Partial<JsonRpcProxy<S>>,
): KhulnasoftServiceImpl<C, S> {
    return new KhulnasoftServiceImpl<C, S>(createServerMock(methods));
};

export const createServerMock = function <S extends KhulnasoftServer>(methods: Partial<JsonRpcProxy<S>>): JsonRpcProxy<S> {
...
export namespace KhulnasoftServer {
    ...
    export interface GenerateNewKhulnasoftTokenOptions {
        name?: string;
        type: KhulnasoftTokenType;
        scopes?: string[];
    }
    export interface OnboardingState {
        /**
         * Whether this Khulnasoft instance is already configured with SSO.
         */
...
export const KhulnasoftServerPath = "/khulnasoft";

export const KhulnasoftServerProxy = Symbol("KhulnasoftServerProxy");
export type KhulnasoftServerProxy<S extends KhulnasoftServer> = JsonRpcProxy<S>;

export class KhulnasoftCompositeClient<Client extends KhulnasoftClient> implements KhulnasoftClient {
...
export type KhulnasoftService = KhulnasoftServiceImpl<KhulnasoftClient, KhulnasoftServer>;
...
export class WorkspaceInstanceUpdateListener {
    ...
    constructor(private readonly service: KhulnasoftService, private _info: WorkspaceInfo) {
...
export interface KhulnasoftServiceOptions {
    onReconnect?: () => void | Promise<void>;
}

export class KhulnasoftServiceImpl<Client extends KhulnasoftClient, Server extends KhulnasoftServer> {
    private readonly compositeClient = new KhulnasoftCompositeClient<Client>();

    constructor(public readonly server: JsonRpcProxy<Server>, private options?: KhulnasoftServiceOptions) {
