...
export interface ProjectSettings {
    ...
    /**
     * Enable automatic authentication for docker daemon with all credentials specified in KHULNASOFT_IMAGE_AUTH
     */
...
export interface OrganizationSettings {
    ...
    // whether to add a special annotation to commits that are created through Khulnasoft
