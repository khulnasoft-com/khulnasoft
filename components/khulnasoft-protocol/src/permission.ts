...
export namespace Permission {
    /** The permission to develop on this running Khulnasoft installation */
    export const DEVELOPER: PermissionName = "developer";

    /** The permission for registry access (start workspaces referencing khulnasoft-internal Docker images) */
...
export namespace Role {
    /** A role for people that are allowed to view Khulnasoft internals */
