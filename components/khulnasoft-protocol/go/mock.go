...
// DeleteKhulnasoftToken mocks base method.
func (m *MockAPIInterface) DeleteKhulnasoftToken(ctx context.Context, tokenHash string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteKhulnasoftToken", ctx, tokenHash)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteKhulnasoftToken indicates an expected call of DeleteKhulnasoftToken.
func (mr *MockAPIInterfaceMockRecorder) DeleteKhulnasoftToken(ctx, tokenHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteKhulnasoftToken", reflect.TypeOf((*MockAPIInterface)(nil).DeleteKhulnasoftToken), ctx, tokenHash)
}
...
// GenerateNewKhulnasoftToken mocks base method.
func (m *MockAPIInterface) GenerateNewKhulnasoftToken(ctx context.Context, options *GenerateNewKhulnasoftTokenOptions) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateNewKhulnasoftToken", ctx, options)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenerateNewKhulnasoftToken indicates an expected call of GenerateNewKhulnasoftToken.
func (mr *MockAPIInterfaceMockRecorder) GenerateNewKhulnasoftToken(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateNewKhulnasoftToken", reflect.TypeOf((*MockAPIInterface)(nil).GenerateNewKhulnasoftToken), ctx, options)
}
...
// GetKhulnasoftTokenScopes mocks base method.
func (m *MockAPIInterface) GetKhulnasoftTokenScopes(ctx context.Context, tokenHash string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetKhulnasoftTokenScopes", ctx, tokenHash)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetKhulnasoftTokenScopes indicates an expected call of GetKhulnasoftTokenScopes.
func (mr *MockAPIInterfaceMockRecorder) GetKhulnasoftTokenScopes(ctx, tokenHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetKhulnasoftTokenScopes", reflect.TypeOf((*MockAPIInterface)(nil).GetKhulnasoftTokenScopes), ctx, tokenHash)
}

// GetKhulnasoftTokens mocks base method.
func (m *MockAPIInterface) GetKhulnasoftTokens(ctx context.Context) ([]*APIToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetKhulnasoftTokens", ctx)
	ret0, _ := ret[0].([]*APIToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetKhulnasoftTokens indicates an expected call of GetKhulnasoftTokens.
func (mr *MockAPIInterfaceMockRecorder) GetKhulnasoftTokens(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetKhulnasoftTokens", reflect.TypeOf((*MockAPIInterface)(nil).GetKhulnasoftTokens), ctx)
}
