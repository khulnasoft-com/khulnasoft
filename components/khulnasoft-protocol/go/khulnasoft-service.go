...
type APIInterface interface {
	...
	GetKhulnasoftTokenScopes(ctx context.Context, tokenHash string) (res []string, err error)
	...
	GetKhulnasoftTokens(ctx context.Context) (res []*APIToken, err error)
	GenerateNewKhulnasoftToken(ctx context.Context, options *GenerateNewKhulnasoftTokenOptions) (res string, err error)
	DeleteKhulnasoftToken(ctx context.Context, tokenHash string) (err error)
...
const (
	...
	// FunctionGetKhulnasoftTokenScopes is the name of the GetKhulnasoftTokenScopes function
	FunctionGetKhulnasoftTokenScopes FunctionName = "getKhulnasoftTokenScopes"
	...
	// FunctionGetKhulnasoftTokens is the name of the getKhulnasoftTokens function
	FunctionGetKhulnasoftTokens FunctionName = "getKhulnasoftTokens"
	// FunctionGenerateNewKhulnasoftToken is the name of the generateNewKhulnasoftToken function
	FunctionGenerateNewKhulnasoftToken FunctionName = "generateNewKhulnasoftToken"
	// FunctionDeleteKhulnasoftToken is the name of the deleteKhulnasoftToken function
	FunctionDeleteKhulnasoftToken FunctionName = "deleteKhulnasoftToken"
...
var errNotConnected = errors.New("not connected to Khulnasoft server")
...
// APIoverJSONRPC makes JSON RPC calls to the Khulnasoft server is the APIoverJSONRPC message type
...
// GetKhulnasoftTokenScopes calls getKhulnasoftTokenScopes on the server
func (gp *APIoverJSONRPC) GetKhulnasoftTokenScopes(ctx context.Context, tokenHash string) (res []string, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result []string
	err = gp.C.Call(ctx, "getKhulnasoftTokenScopes", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// GetKhulnasoftTokens calls getKhulnasoftTokens on the server
func (gp *APIoverJSONRPC) GetKhulnasoftTokens(ctx context.Context) (res []*APIToken, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result []*APIToken
	err = gp.C.Call(ctx, "getKhulnasoftTokens", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// GenerateNewKhulnasoftToken calls generateNewKhulnasoftToken on the server
func (gp *APIoverJSONRPC) GenerateNewKhulnasoftToken(ctx context.Context, options *GenerateNewKhulnasoftTokenOptions) (res string, err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	var result string
	err = gp.C.Call(ctx, "generateNewKhulnasoftToken", _params, &result)
	if err != nil {
		return
	}
	res = result
...
// DeleteKhulnasoftToken calls deleteKhulnasoftToken on the server
func (gp *APIoverJSONRPC) DeleteKhulnasoftToken(ctx context.Context, tokenHash string) (err error) {
	if gp == nil {
		err = errNotConnected
		return
	}
	...
	err = gp.C.Call(ctx, "deleteKhulnasoftToken", _params, nil)
	if err != nil {
		return
	}
...
type WorkspaceConfig struct {
	...
	// that is set by khulnasoft at workspace creation time.
...
// GenerateNewKhulnasoftTokenOptions is the GenerateNewKhulnasoftTokenOptions message type
type GenerateNewKhulnasoftTokenOptions struct {
	Name string `json:"name,omitempty"`
...
type User struct {
	...
	// A map of random settings that alter the behaviour of Khulnasoft on a per-user basis
