...
func TestScrub(t *testing.T) {
	...
	// log.WithFieldSensitive("workspaceID", "khulnasoftio-khulnasoft-uesaddev73c").Info("hello world")
	scrubber.KeyValue("workspaceID", "khulnasoftio-khulnasoft-uesaddev73c") // -> [scrubbed:md5:ae3e415b124cdbac878e995cad169490]
