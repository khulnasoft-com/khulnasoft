...
import (
	...
	v1 "github.com/khulnasoft-com/khulnasoft/ws-manager/api/crd/v1"
...
func TestCreateWorkspaceEnvironment(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			Expectation: Expectation{
				Vars: []corev1.EnvVar{
					{Name: "KHULNASOFT_REPO_ROOT", Value: "/workspace"},
					{Name: "KHULNASOFT_REPO_ROOTS", Value: "/workspace"},
					{Name: "KHULNASOFT_THEIA_PORT", Value: "0"},
					{Name: "THEIA_WORKSPACE_ROOT", Value: "/workspace"},
					{Name: "KHULNASOFT_WORKSPACE_CLASS", Value: "default"},
					...
					{Name: "KHULNASOFT_GIT_USER_NAME", Value: "foobar"},
					{Name: "KHULNASOFT_GIT_USER_EMAIL", Value: "foo@bar.com"},
					{Name: "KHULNASOFT_INTERVAL", Value: "0"}, {Name: "KHULNASOFT_MEMORY", Value: "0"}, {Name: "KHULNASOFT_CPU_COUNT", Value: "0"},
				},
			},
		},
		{
