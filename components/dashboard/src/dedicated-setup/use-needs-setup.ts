...
import { GetOnboardingStateRequest } from "@khulnasoft/public-api/lib/khulnasoft/v1/installation_pb";
...
// TODO: This is a temporary safety-guard against this flow showing up on khulnasoft.com
...
export const isCurrentHostExcludedFromSetup = () => {
    // Purposely not using isKhulnasoftIo() check here to avoid disabling on preview environments too.
    return ["khulnasoft.com", "khulnasoft-staging.com"].includes(window.location.hostname);
};
