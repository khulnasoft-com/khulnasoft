...
import { OIDCClientConfig } from "@khulnasoft/public-api/lib/khulnasoft/experimental/v1/oidc_pb";
        ...
        <SetupLayout showOrg progressCurrent={progressCurrent} progressTotal={progressTotal}>
            <div className="mb-10">
                ...
                <Subheading>
                    ...
                    <a
                        href="https://www.khulnasoft.com/docs/enterprise/setup-khulnasoft/configure-sso"
                        target="_blank"
