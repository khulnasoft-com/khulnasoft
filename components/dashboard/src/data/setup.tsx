...
import * as OrganizationClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/organization_pb";
import * as WorkspaceClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_pb";
import * as PaginationClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/pagination_pb";
import * as ConfigurationClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/configuration_pb";
import * as AuthProviderClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/authprovider_pb";
import * as EnvVarClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/envvar_pb";
import * as PrebuildClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/prebuild_pb";
import * as VerificationClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/verification_pb";
import * as InstallationClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/installation_pb";
import * as SCMClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/scm_pb";
import * as SSHClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/ssh_pb";
import * as UserClasses from "@khulnasoft/public-api/lib/khulnasoft/v1/user_pb";
...
export const setupQueryClientProvider = () => {
    ...
    const KhulnasoftQueryClientProvider: FunctionComponent = ({ children }) => {
        return (
    ...
    return KhulnasoftQueryClientProvider;
};

// Persister that uses IndexedDB
export function createIDBPersister(idbValidKey: IDBValidKey = "khulnasoftQueryClient"): Persister {
