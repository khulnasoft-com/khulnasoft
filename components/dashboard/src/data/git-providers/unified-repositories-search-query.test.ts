...
test("should perform weak validation for git URLs", () => {
    ...
    expect(isValidGitUrl("https://github.com/khulnasoft-com/khulnasoft/pull/20281")).toEqual(true);
    expect(isValidGitUrl("https://gitlab.com/filiptronicek/khulnasoft.git")).toEqual(true);
    expect(isValidGitUrl("git@github.com:khulnasoft-com/khulnasoft.git")).toEqual(true);
    expect(isValidGitUrl("git@gitlab.com:filiptronicek/khulnasoft.git")).toEqual(true);
    expect(isValidGitUrl("ssh://login@server.com:12345/~/repository.git")).toBe(true);
    expect(isValidGitUrl("https://bitbucket.khulnasoft-dev.com/scm/~geropl/test-user-repo.git")).toBe(true);
    expect(isValidGitUrl("git://gitlab.com/khulnasoft/spring-petclinic")).toBe(true);
