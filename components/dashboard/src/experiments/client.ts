...
import { ConfigCatClient } from "@khulnasoft/khulnasoft-protocol/lib/experiments/configcat";
import { Client } from "@khulnasoft/khulnasoft-protocol/lib/experiments/types";
...
function newProxyConfigCatClient(): Client {
    const clientKey = "khulnasoft"; // the client key is populated by the proxy
