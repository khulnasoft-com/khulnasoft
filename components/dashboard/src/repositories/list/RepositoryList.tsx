...
import type { Configuration } from "@khulnasoft/public-api/lib/khulnasoft/v1/configuration_pb";
        ...
        <>
            <div className="app-container pb-8">
                <PageHeading
                    ...
                    subtitle="Configure and refine the experience of working with a repository in Khulnasoft."
                />
