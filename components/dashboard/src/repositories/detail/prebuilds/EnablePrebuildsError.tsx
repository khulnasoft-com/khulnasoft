...
import type { RepositoryUnauthorizedError } from "@khulnasoft/public-api/lib/khulnasoft/v1/error_pb";
...
//   - We can provide a link to the khulnasoft oauth app settings for them to have an admin approve it
