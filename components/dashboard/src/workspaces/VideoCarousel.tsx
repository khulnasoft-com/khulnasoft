...
const videos: Video[] = [
    { id: "1ZBN-b2cIB8", title: "Khulnasoft in 120 seconds", analyticsLabel: "khulnasoft-demo" },
    { id: "zhZNnzFlZnY", title: "Getting started with Khulnasoft", analyticsLabel: "getting-started-with-khulnasoft" },
    { id: "kuoHM2bpBqY", title: "Fully automate your dev setup", analyticsLabel: "automate-khulnasoft-setup" },
    { id: "_CwFzCbAsoU", title: "Personalise your workspace", analyticsLabel: "personalise-khulnasoft-workspace" },
];
