...
import { AdmissionLevel, Workspace, WorkspacePhase_Phase } from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_pb";
...
export const WorkspaceEntryOverflowMenu: FunctionComponent<WorkspaceEntryOverflowMenuProps> = ({
    ...
    const startUrl = useMemo(
        () =>
            new KhulnasoftHostUrl(window.location.href).with({
                pathname: "/start/",
                hash: "#" + workspace.id,
            }),
        [workspace.id],
    ...
    const downloadURL = useMemo(
        () =>
            new KhulnasoftHostUrl(window.location.href)
                .with({
