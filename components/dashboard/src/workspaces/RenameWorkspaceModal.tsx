...
import { Workspace } from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_pb";
import { useUpdateWorkspaceMutation } from "../data/workspaces/update-workspace-mutation";
import { LoadingButton } from "@podkit/buttons/LoadingButton";
import { Workspace as WorkspaceProtocol } from "@khulnasoft/khulnasoft-protocol";
        ...
        <Modal visible onClose={onClose} onSubmit={updateWorkspaceDescription}>
            ...
            <ModalBody>
                {errorMessage.length > 0 ? (
                    <div className="bg-kumquat-light rounded-md p-3 text-khulnasoft-red text-sm mb-2">{errorMessage}</div>
                ) : null}
                <input
                    autoFocus
