...
const installationOptions: BrowserOption[] = [
    {
        type: "firefox",
        aliases: ["firefox"],
        url: "https://addons.mozilla.org/en-US/firefox/addon/khulnasoft/",
    },
    {
        type: "chromium",
        aliases: ["chrome", "edge", "brave", "chromium", "vivaldi", "opera"],
        url: "https://chrome.google.com/webstore/detail/khulnasoft-always-ready-to-co/dodmmooeoklaejobgleioelladacbeki",
    },
];
                ...
                <div className="flex flex-col gap-1 py-5 pl-6 pr-8 justify-center">
                    ...
                    <span className="text-sm">
                        <a
                            ...
                            rel="noreferrer"
                        >
                            Install the Khulnasoft extension
                        </a>{" "}
                        to launch workspaces from {scmProviderString}.
                    </span>
                </div>
                <img
                    alt="A button that says Khulnasoft"
