...
const banners = [
    {
        ...
        title: "Beyond Kubernetes: A deep-dive into Khulnasoft Flex with our CTO",
        link: "https://www.khulnasoft.com/events#watch-on-demand",
    },
    {
        type: "Blog Post",
        title: "Khulnasoft Enterprise:<br/> Self-hosted, not self-managed",
        link: "https://www.khulnasoft.com/blog/self-hosted-not-self-managed",
    },
    {
        type: "Customer Story",
        title: "Thousands of hours spent on VM-based development environments reduced to zero using Khulnasoft",
        link: "https://www.khulnasoft.com/customers/kingland",
    },
    {
        type: "Gartner Report",
        title: `"By 2026, 60% of cloud workloads will be built and deployed using CDE's"`,
        link: "https://www.khulnasoft.com/blog/gartner-2023-cde-hypecycle",
    },
];
