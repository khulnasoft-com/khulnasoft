...
import { hoursBefore, isDateSmallerOrEqual } from "@khulnasoft/khulnasoft-protocol/lib/util/timeutil";
import { Workspace, WorkspacePhase_Phase } from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_pb";
...
import { ReactComponent as KhulnasoftStrokedSVG } from "../icons/khulnasoft-stroked.svg";
            ...
            {isEnterpriseOnboardingEnabled && isDedicatedInstallation && (
                <>
                    <div className="app-container flex flex-row items-center justify-end mt-4 mb-2">
                        <Tooltip content="Toggle helpful resources for getting started with Khulnasoft">
                            <Button
                                variant="ghost"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:px-28 px-4 pb-4">
                                <Card onClick={() => setVideoModalVisible(true)}>
                                    ...
                                    <div className="min-w-0">
                                        <CardTitle>Learn how Khulnasoft works</CardTitle>
                                        <CardDescription>
                                            We've put together resources for you to get the most out of Khulnasoft.
                                        </CardDescription>
                                    </div>
                                </Card>
                                ...
                                {orgSettings?.onboardingSettings?.internalLink ? (
                                    <Card href={orgSettings.onboardingSettings.internalLink} isLinkExternal>
                                        ...
                                        <div className="min-w-0">
                                            <CardTitle>Learn more about Khulnasoft at {org?.name}</CardTitle>
                                            <CardDescription>
                                                Read through the internal Khulnasoft landing page of your organization.
                                            </CardDescription>
                                        </div>
                                    </Card>
                                ) : (
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <CardDescription>
                                                ...
                                                {orgSuggestedRepos?.length
                                                    ...
                                                    : "a sample repository"}{" "}
                                                to quickly experience Khulnasoft.
                                            </CardDescription>
                                        </div>
                                    </Card>
                                )}

                                <Card href="https://www.khulnasoft.com/docs/introduction" isLinkExternal>
                    ...
                    >
                        ...
                        <ModalBody>
                            <div className="flex flex-row items-center justify-center">
                                <VideoSection
                                    metadataVideoTitle="Khulnasoft demo"
                ...
                (activeWorkspaces.length > 0 || inactiveWorkspaces.length > 0 || searchTerm ? (
                    <>
                        ...
                        >
                                                ...
                                                <div className="flex flex-grow flex-col ">
                                                    ...
                                                    <div className="text-sm flex-auto">
                                                        ...
                                                        <a
                                                            ...
                                                            rel="noreferrer"
                                                            className="gp-link"
                                                            href="https://www.khulnasoft.com/docs/configure/workspaces/workspace-lifecycle#workspace-deletion"
                            ...
                            {/* Show Educational if user is in khulnasoftIo */}
                                ...
                                <div className="max-xl:hidden border-l border-gray-200 dark:border-gray-800 pl-6 pt-5 pb-4 space-y-8">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="flex flex-col gap-1 w-fit">
                                            <a
                                                href="https://www.khulnasoft.com/docs/introduction"
                                                target="_blank"
                                            ...
                                            <a
                                                href="https://www.khulnasoft.com/docs/configure/workspaces"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-sm text-pk-content-primary items-center gap-x-2 flex flex-row"
                                            >
                                                <KhulnasoftStrokedSVG />
                                                <span className="hover:text-blue-600 dark:hover:text-blue-400">
                                                    Configuring a workspace
                                                </span>
                                            </a>
                                            <a
                                                href="https://www.khulnasoft.com/docs/references/khulnasoft-yml"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-sm text-pk-content-primary items-center gap-x-2 flex flex-row"
                                            >
