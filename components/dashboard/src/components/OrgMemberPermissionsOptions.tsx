...
import { VALID_ORG_MEMBER_ROLES } from "@khulnasoft/khulnasoft-protocol";
import { OrganizationPermission, RoleRestrictionEntry } from "@khulnasoft/public-api/lib/khulnasoft/v1/organization_pb";
