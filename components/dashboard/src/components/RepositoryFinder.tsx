...
import KhulnasoftRepositoryTemplateSVG from "../icons/KhulnasoftRepositoryTemplate.svg";
...
const resolveIcon = (contextUrl?: string): string => {
    ...
    return PREDEFINED_REPOS.some((repo) => repo.url === contextUrl) ? KhulnasoftRepositoryTemplateSVG : RepositorySVG;
};
