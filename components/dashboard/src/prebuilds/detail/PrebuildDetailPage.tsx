...
import { Prebuild, PrebuildPhase_Phase, TaskLog } from "@khulnasoft/public-api/lib/khulnasoft/v1/prebuild_pb";
                                ...
                                <Tabs value={taskId ?? "empty-tab"} onValueChange={setSelectedTaskId} className="p-0">
                                    ...
                                    {prebuildTasks.length !== 0 ? (
                                        ...
                                        <PrebuildTaskErrorTab>
                                            No prebuild tasks defined in <code>.khulnasoft.yml</code> for this prebuild
                                        </PrebuildTaskErrorTab>
                                    )}
                                </Tabs>
                            </div>
