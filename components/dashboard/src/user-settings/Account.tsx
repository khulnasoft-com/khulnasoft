...
import { User as UserProtocol, ProfileDetails } from "@khulnasoft/khulnasoft-protocol";
...
export default function Account() {
    ...
    const deleteAccount = useCallback(async () => {
        await getKhulnasoftService().server.deleteAccount();
        document.location.href = khulnasoftHostUrl.asApiLogout().toString();
    }, []);
        ...
        <div>
            ...
            >
                <ol className="text-gray-500 text-sm list-outside list-decimal">
                    ...
                    <li className="ml-5">
                        Your subscription will be cancelled. If you obtained a Khulnasoft subscription through the GitHub
            ...
            <PageWithSettingsSubMenu>
                ...
                <Subheading className="mb-3">
                    This action will remove all the data associated with your account in Khulnasoft.
                </Subheading>
