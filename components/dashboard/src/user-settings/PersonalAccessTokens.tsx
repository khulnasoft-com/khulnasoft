...
import { PersonalAccessToken } from "@khulnasoft/public-api/lib/khulnasoft/experimental/v1/tokens_pb";
        ...
        <>
            <div className="flex items-center sm:justify-between mb-4">
                <div>
                    ...
                    <Subheading>
                        ...
                        <a
                            className="gp-link"
                            href="https://www.khulnasoft.com/docs/configure/user-settings/access-tokens"
                            target="_blank"
                            rel="noreferrer"
                        >
                            Learn more
                    ...
                    {tokens.length === 0 ? (
                        <div className="bg-pk-surface-secondary rounded-xl w-full py-28 flex flex-col items-center">
                            ...
                            <Subheading className="text-center pb-6 w-96">
                                Generate an access token for applications that need access to the Khulnasoft API.{" "}
                            </Subheading>
                            <LinkButton href={settingsPathPersonalAccessTokenCreate}>New Access Token</LinkButton>
                        </div>
                    ) : (
            ...
            {modalData?.action === TokenAction.Delete && (
                <ShowTokenModal
                    ...
                    descriptionImportant="Any applications using this token will no longer be able to access the Khulnasoft API."
