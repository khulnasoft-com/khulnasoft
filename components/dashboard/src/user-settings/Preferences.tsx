...
export default function Preferences() {
    ...
    const saveWorkspaceTimeout = useCallback(
        async (e) => {
            ...
            try {
                await getKhulnasoftService().server.updateWorkspaceTimeoutSetting({
        ...
        <div>
            <PageWithSettingsSubMenu>
                ...
                <Subheading>
                    ...
                    <a
                        className="gp-link"
                        href="https://www.khulnasoft.com/docs/references/ides-and-editors"
                        target="_blank"
                        rel="noreferrer"
                    >
                        Learn more
                ...
                <form className="mt-4 max-w-xl" onSubmit={saveDotfileRepo}>
                    <InputField
                        ...
                        hint="Add a repository URL that includes dotfiles. Khulnasoft will clone and install your dotfiles for every new workspace."
                    >
                    ...
                    <form onSubmit={saveWorkspaceTimeout}>
                        ...
                        >
                            <div className="flex flex-col">
                                ...
                                {creationError && (
                                    <p className="text-khulnasoft-red w-full max-w-lg">
