...
import { UserEnvironmentVariable } from "@khulnasoft/public-api/lib/khulnasoft/v1/envvar_pb";
...
function AddEnvVarModal(p: EnvVarModalProps) {
    ...
    return (
        <Modal visible={true} onClose={p.onClose} onSubmit={save}>
            ...
            <ModalBody>
                {error ? (
                    <div className="bg-kumquat-light rounded-md p-3 text-khulnasoft-red text-sm mb-2">{error}</div>
                ) : null}
                <TextInputField
                    label="Name"
                    value={ev.name}
            ...
            <div className="flex items-start sm:justify-between mb-2">
                <div>
                    ...
                    <Subheading>
                        ...
                        <a
                            className="gp-link"
                            href="https://www.khulnasoft.com/docs/configure/projects/environment-variables#environment-variables"
                            target="_blank"
                            rel="noreferrer"
                        >
                            Learn more
