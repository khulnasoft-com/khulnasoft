...
export function SelectAccountModal(
    ...
    const continueWithOtherAccount = () => {
        const accessControlUrl = khulnasoftHostUrl.asAccessControl().toString();

        const loginUrl = khulnasoftHostUrl
            .withApi({
                pathname: "/login",
        ...
        const logoutUrl = khulnasoftHostUrl
            .withApi({
                pathname: "/logout",
        ...
        <Modal visible={true} onClose={props.close}>
            ...
            <ModalBody>
                <p className="pb-2 text-gray-500 text-base">
                    You are trying to authorize a provider that is already connected with another account on Khulnasoft.
                </p>
