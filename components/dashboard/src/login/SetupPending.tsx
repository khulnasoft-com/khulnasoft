...
import khulnasoftIcon from "../images/khulnasoft.svg";
import khulnasoftDarkIcon from "../images/khulnasoft-dark.svg";
        ...
        <div className="flex-grow flex items-center justify-center p-4">
            <div className={classNames(alwaysShowHeader ? "" : "lg:hidden", "absolute top-0 left-0 right-0")}>
                <div className="flex items-center justify-center items-center py-3 space-x-1">
                    <img src={isDark ? khulnasoftDarkIcon : khulnasoftIcon} className="h-8" alt="Khulnasoft's logo" />
                </div>
            </div>
            <div className="max-w-md flex flex-col items-center justify-center text-center">
                ...
                <Subheading>This instance of Khulnasoft is not quite ready.</Subheading>
