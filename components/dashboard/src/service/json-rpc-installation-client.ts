...
export class JsonRpcInstallationClient implements PromiseClient<typeof InstallationService> {
    async getInstallationWorkspaceDefaultImage(
        ...
        const result = await getKhulnasoftService().server.getDefaultWorkspaceImage({});
    ...
    async listBlockedRepositories(
        ...
        const info = await getKhulnasoftService().server.adminGetBlockedRepositories({
            limit: 100,
            offset: 0,
            orderBy: "urlRegexp",
            orderDir: "asc",
    ...
    async createBlockedRepository(
        ...
        const info = await getKhulnasoftService().server.adminCreateBlockedRepository(
            request.urlRegexp,
            request.blockUser,
    ...
    async deleteBlockedRepository(
        ...
        await getKhulnasoftService().server.adminDeleteBlockedRepository(request.blockedRepositoryId);
    ...
    async listBlockedEmailDomains(
        ...
        const info = await getKhulnasoftService().server.adminGetBlockedEmailDomains();
    ...
    async createBlockedEmailDomain(
        ...
        await getKhulnasoftService().server.adminSaveBlockedEmailDomain({
    ...
    async getOnboardingState(
        ...
        const info = await getKhulnasoftService().server.getOnboardingState();
    ...
    async getInstallationConfiguration(
        ...
        const config = await getKhulnasoftService().server.getConfiguration();
