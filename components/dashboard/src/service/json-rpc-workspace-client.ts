...
import { PaginationResponse } from "@khulnasoft/public-api/lib/khulnasoft/v1/pagination_pb";
import { generateAsyncGenerator } from "@khulnasoft/khulnasoft-protocol/lib/generate-async-generator";
import { WorkspaceInstance } from "@khulnasoft/khulnasoft-protocol";
...
export class JsonRpcWorkspaceClient implements PromiseClient<typeof WorkspaceService> {
    ...
    async getWorkspace(request: PartialMessage<GetWorkspaceRequest>): Promise<GetWorkspaceResponse> {
        ...
        const info = await getKhulnasoftService().server.getWorkspace(request.workspaceId);
    ...
    async listWorkspaces(
        ...
        let resultTotal = 0;
        const results = await getKhulnasoftService().server.getWorkspaces({
            limit,
    ...
    async createAndStartWorkspace(
        ...
        const response = await getKhulnasoftService().server.createWorkspace({
    ...
    async startWorkspace(request: PartialMessage<StartWorkspaceRequest>, _options?: CallOptions | undefined) {
        ...
        await getKhulnasoftService().server.startWorkspace(request.workspaceId, {
    ...
    async getWorkspaceDefaultImage(
        ...
        const response = await getKhulnasoftService().server.getDefaultWorkspaceImage({
    ...
    async sendHeartBeat(
        ...
        await getKhulnasoftService().server.sendHeartBeat({
    ...
    async getWorkspaceOwnerToken(
        ...
        const ownerToken = await getKhulnasoftService().server.getOwnerToken(request.workspaceId);
    ...
    async getWorkspaceEditorCredentials(
        ...
        const credentials = await getKhulnasoftService().server.getIDECredentials(request.workspaceId);
    ...
    async updateWorkspace(
        ...
        const server = getKhulnasoftService().server;
    ...
    async stopWorkspace(
        ...
        await getKhulnasoftService().server.stopWorkspace(request.workspaceId);
    ...
    async deleteWorkspace(
        ...
        await getKhulnasoftService().server.deleteWorkspace(request.workspaceId);
    ...
    async parseContextURL(
        ...
        const context = await getKhulnasoftService().server.resolveContext(request.contextUrl);
    ...
    async listWorkspaceClasses(
        ...
        const list = await getKhulnasoftService().server.getSupportedWorkspaceClasses();
    ...
    async createWorkspaceSnapshot(
        ...
        const snapshotId = await getKhulnasoftService().server.takeSnapshot({
    ...
    async waitForWorkspaceSnapshot(
        ...
        await getKhulnasoftService().server.waitForSnapshot(req.snapshotId);
    ...
    async updateWorkspacePort(
        ...
        getKhulnasoftService().server.openPort(req.workspaceId, {
