...
import { UserEnvVar, UserEnvVarValue } from "@khulnasoft/khulnasoft-protocol";
...
export class JsonRpcEnvvarClient implements PromiseClient<typeof EnvironmentVariableService> {
    async listUserEnvironmentVariables(
        ...
        const userEnvVars = await getKhulnasoftService().server.getAllEnvVars();
    ...
    async updateUserEnvironmentVariable(
        ...
        if (userEnvVarfound) {
            ...
            await getKhulnasoftService().server.setEnvVar(variable);

            const updatedUserEnvVars = await getKhulnasoftService().server.getAllEnvVars();
    ...
    async deleteUserEnvironmentVariable(
        ...
        await getKhulnasoftService().server.deleteEnvVar(variable);
    ...
    async listConfigurationEnvironmentVariables(
        ...
        const projectEnvVars = await getKhulnasoftService().server.getProjectEnvironmentVariables(req.configurationId);
    ...
    async updateConfigurationEnvironmentVariable(
        ...
        if (projectEnvVarfound) {
            await getKhulnasoftService().server.setProjectEnvironmentVariable(
                req.configurationId,
            ...
            const updatedProjectEnvVars = await getKhulnasoftService().server.getProjectEnvironmentVariables(
                req.configurationId,
            );
    ...
    async deleteConfigurationEnvironmentVariable(
        ...
        await getKhulnasoftService().server.deleteProjectEnvironmentVariable(req.environmentVariableId);
