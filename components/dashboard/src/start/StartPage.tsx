...
import { GetWorkspaceDefaultImageResponse_Source } from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_pb";
...
function StartError(props: { error: StartWorkspaceError }) {
    ...
    return <p className="text-base text-khulnasoft-red w-96">{error.message}</p>;
}
