...
import { DisposableCollection, RateLimiterError, WorkspaceImageBuild } from "@khulnasoft/khulnasoft-protocol";
import { IDEOptions } from "@khulnasoft/khulnasoft-protocol/lib/ide-protocol";
...
import { getKhulnasoftService, khulnasoftHostUrl, getIDEFrontendService, IDEFrontendService } from "../service/service";
...
export interface StartWorkspaceProps {
    ...
    /**
     * This flag is used to break the autostart-cycle explained in https://github.com/khulnasoft-com/khulnasoft/issues/8043
     */
...
export default class StartWorkspace extends React.Component<StartWorkspaceProps, StartWorkspaceState> {
    ...
    componentWillMount() {
        if (this.props.runsInIFrame) {
            this.ideFrontendService = getIDEFrontendService(this.props.workspaceId, sessionId, getKhulnasoftService());
            this.toDispose.push(
        ...
        try {
            ...
            this.toDispose.push(
                getKhulnasoftService().registerClient({
    ...
    async startWorkspace(restart = false, forceDefaultConfig = false) {
        ...
        try {
            ...
            if (normalizedError?.code === ErrorCodes.USER_BLOCKED) {
                this.redirectTo(khulnasoftHostUrl.with({ pathname: "/blocked" }).toString());
                return;
            }
    ...
    /**
     * TODO(gpl) Ideally this can be pushed into the KhulnasoftService implementation. But to get started we hand-roll it here.
     * @param workspaceId
     * @param options
     * @returns
     */
    ...
    protected async fetchIDEOptions() {
        const ideOptions = await getKhulnasoftService().server.getIDEOptions();
    ...
    private async onWorkspaceUpdate(workspace?: Workspace) {
        ...
        if (
            ...
            if (contextURL) {
                this.redirectTo(khulnasoftHostUrl.withContext(contextURL.toString()).toString());
            } else {
    ...
    async ensureWorkspaceAuth(instanceID: string, retry: boolean) {
        ...
        while (attempt <= MAX_ATTEMPTS) {
            ...
            try {
                const authURL = khulnasoftHostUrl.asWorkspaceAuth(instanceID);
                                ...
                                <ContextMenu
                                    menuEntries={[
                                        ...
                                        },
                                        {
                                            ...
                                            href: khulnasoftHostUrl.asWorkspacePage().toString(),
                                            target: "_parent",
                                        },
                                    ]}
                                >
                            ...
                            {!useLatest && (
                                <Alert type="info" className="mt-4 w-96">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        href={khulnasoftHostUrl.asPreferences().toString()}
                                    >
                                        user preferences
                                    </a>
                                    .
                ...
                statusMessage = (
                    <div>
                        ...
                        <div className="mt-10 flex justify-center">
                            <a target="_parent" href={khulnasoftHostUrl.asWorkspacePage().toString()}>
                ...
                statusMessage = (
                    <div>
                        ...
                        <div className="mt-10 justify-center flex space-x-2">
                            ...
                            <a target="_parent" href={khulnasoftHostUrl.asStart(this.state.workspace.id).toString()}>
                ...
                {this.state.showRedirectMessage && (
                    <>
                        ...
                        <div className="mt-4 justify-center flex space-x-2">
                            <LinkButton href={khulnasoftHostUrl.asWorkspacePage().toString()} target="_self" isExternalUrl>
                                Go to Dashboard
                            </LinkButton>
...
function ImageBuildView(props: ImageBuildViewProps) {
    ...
    useEffect(() => {
        ...
        const toDispose = getKhulnasoftService().registerClient({
                ...
                <>
                    <div className="mt-6 w-11/12 lg:w-3/5">
                        <p className="text-center text-gray-400 dark:text-gray-500">
                            ...
                            <a
                                href="https://www.khulnasoft.com/docs/configure/workspaces#validate-your-khulnasoft-configuration"
                                target="_blank"
