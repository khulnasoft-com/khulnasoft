...
import { Usage, WorkspaceInstanceUsageData } from "@khulnasoft/khulnasoft-protocol/lib/usage";
            ...
            <div className="flex flex-col col-span-3 my-auto">
                ...
                <div className="flex">
                    ...
                    {metadata.workspaceType === "prebuild" ? (
                        <span className="text-sm text-gray-400 dark:text-gray-500">Khulnasoft</span>
                    ) : (
                        <div className="flex">
                            <img
