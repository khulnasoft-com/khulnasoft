...
import { OrganizationMember, OrganizationRole } from "@khulnasoft/public-api/lib/khulnasoft/v1/organization_pb";
                        ...
                        {isKhulnasoftIo() && (
                            <div className="text-pk-content-tertiary mt-3">
                                ...
                                <a
                                    ...
                                    href="https://www.khulnasoft.com/docs/enterprise"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    Try Khulnasoft Enterprise
                                </a>
                            </div>
                        )}
                    </ModalBody>
