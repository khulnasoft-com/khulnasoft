...
import { EnvVar } from "@khulnasoft/khulnasoft-protocol";
import { ErrorCode } from "@khulnasoft/khulnasoft-protocol/lib/messaging/error";
import { OrganizationSettings } from "@khulnasoft/public-api/lib/khulnasoft/v1/organization_pb";
...
export default function TeamSettingsPage() {
    ...
    const khulnasoftImageAuthEnvVar = orgEnvVars.data?.find((v) => v.name === EnvVar.KHULNASOFT_IMAGE_AUTH_ENV_VAR_NAME);
    ...
    const deleteTeam = useCallback(async () => {
        ...
        invalidateOrgs();
        document.location.href = khulnasoftHostUrl.asDashboard().toString();
                    ...
                    {org?.id && (
                        <ConfigurationSettingsField>
                            ...
                            <NamedOrganizationEnvvarItem
                                disabled={!isOwner}
                                name={EnvVar.KHULNASOFT_IMAGE_AUTH_ENV_VAR_NAME}
                                organizationId={org.id}
                                variable={khulnasoftImageAuthEnvVar}
                            />
                        </ConfigurationSettingsField>
                    )}
                    ...
                    {isCommitAnnotationEnabled && (
                        <ConfigurationSettingsField>
                            ...
                            <Subheading className="mb-4">
                                Configure insights into usage of Khulnasoft in your organization.
                            </Subheading>
                            ...
                            <InputField
                                ...
                                hint={
                                    <>
                                        ...
                                        workspaces in your organization to associate them with this Khulnasoft instance.
                                    </>
                                }
        ...
        >
            ...
            <ModalBody>
                ...
                <div className="mt-4">
                    <TextInputField
                        label="Default Image"
                        hint="Use any official or custom workspace image from Docker Hub or any private container registry that the Khulnasoft instance can access."
