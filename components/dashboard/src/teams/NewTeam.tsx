    ...
    return (
        <div className="flex flex-col w-96 mt-24 mx-auto items-center">
            ...
            <Subheading className="text-center">
                <a href="https://www.khulnasoft.com/docs/configure/teams" className="gp-link">
                    Organizations
                </a>{" "}
                allow you to manage related{" "}
                <a href="https://www.khulnasoft.com/docs/configure/repositories" className="gp-link">
                    repositories
                </a>{" "}
            ...
            <form className="mt-6 mb-4" onSubmit={createTeam}>
                <div className="rounded-xl p-6 bg-pk-surface-secondary">
                    ...
                    />
                    {!!creationError && (
                        <p className="text-khulnasoft-red">
