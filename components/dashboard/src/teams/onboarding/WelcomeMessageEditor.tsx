...
import type { OnboardingSettings_WelcomeMessage } from "@khulnasoft/public-api/lib/khulnasoft/v1/organization_pb";
...
import { khulnasoftWelcomeSubheading } from "./WelcomeMessageConfigurationField";
        ...
        <Modal onClose={() => setIsOpen(false)} visible={isOpen} containerClassName="min-[576px]:max-w-[650px]">
            ...
            <ModalBody>
                <form id="welcome-message-editor" onSubmit={updateWelcomeMessage} className="space-y-4">
                    <TextInput readOnly value="Welcome to Khulnasoft" className="cursor-default"></TextInput>
                    <Textarea value={khulnasoftWelcomeSubheading} readOnly className="cursor-default resize-none" />
