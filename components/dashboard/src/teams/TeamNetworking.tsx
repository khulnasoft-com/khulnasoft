...
const SelfHostedCalloutCard = () => {
    return (
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <Subheading className="mt-1">
                Deploy the Khulnasoft infrastructure into your own cloud account and connect to your private network
            </Subheading>
            ...
            <LinkButton
                href="https://www.khulnasoft.com/contact/enterprise-self-serve"
                isExternalUrl={true}
                className="mt-8"
            >
                Request Free Trial
...
const DeployedRegionCard = () => {
    return (
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <Subheading className="mt-1">
                Deploy Khulnasoft to any location, such as: United States, South America, Europe and Asia Pacific
            </Subheading>
            ...
            <LinkButton
                ...
                href="https://www.khulnasoft.com/docs/enterprise/overview#aws-support-and-regions"
                isExternalUrl={true}
            >
                Documentation
            </LinkButton>
    ...
    return (
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <LinkButton
                variant="secondary"
                className="mt-8 border border-pk-content-tertiary text-pk-content-primary bg-pk-surface-primary"
                href="https://www.khulnasoft.com/docs/enterprise/getting-started/networking#private-networking-configuration-highly-restrictive"
                isExternalUrl={true}
            >
                Documentation
            </LinkButton>
