...
export const SSOConfigForm: FC<Props> = ({ config, readOnly = false, onChange }) => {
    const redirectUrl = khulnasoftHostUrl.with({ pathname: `/iam/oidc/callback` }).toString();
    ...
    return (
        <>
            ...
            <Subheading className="mt-8">
                ...
                <a
                    href="https://www.khulnasoft.com/docs/enterprise/setup-khulnasoft/configure-sso#restrict-available-accounts-in-your-identity-providers"
                    target="_blank"
