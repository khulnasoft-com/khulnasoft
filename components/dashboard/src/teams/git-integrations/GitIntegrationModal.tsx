...
import { AuthProvider, AuthProviderType } from "@khulnasoft/public-api/lib/khulnasoft/v1/authprovider_pb";
...
const callbackUrl = () => {
    ...
    return khulnasoftHostUrl.with({ pathname }).toString();
};
...
const RedirectUrlDescription: FunctionComponent<RedirectUrlDescriptionProps> = ({ type }) => {
    ...
    switch (type) {
        case AuthProviderType.GITHUB:
            docsUrl = `https://www.khulnasoft.com/docs/configure/authentication/github-enterprise`;
            break;
        case AuthProviderType.GITLAB:
            docsUrl = `https://www.khulnasoft.com/docs/configure/authentication/gitlab#registering-a-self-hosted-gitlab-installation`;
            break;
        case AuthProviderType.BITBUCKET:
            docsUrl = `https://www.khulnasoft.com/docs/configure/authentication`;
            break;
        case AuthProviderType.BITBUCKET_SERVER:
            docsUrl = "https://www.khulnasoft.com/docs/configure/authentication/bitbucket-server";
            break;
        case AuthProviderType.AZURE_DEVOPS:
            docsUrl = "https://www.khulnasoft.com/docs/configure/authentication/azure-devops";
            break;
        default:
            return null;
    }
