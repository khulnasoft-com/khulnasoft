    ...
    return (
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <div className="mt-8 flex flex-col space-y-2">
                ...
                <div className="flex flex-row gap-2 items-center text-pk-content-secondary">
                    <CheckCircle2Icon size={20} className="text-pk-content-primary" />
                    Instantly revoke access and off-board users from Khulnasoft
                </div>
            </div>
    ...
    return (
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <LinkButton
                ...
                href="https://www.khulnasoft.com/docs/enterprise/setup-khulnasoft/use-private-ecr-repos-for-workspace-images"
                isExternalUrl={true}
            >
                Documentation
            </LinkButton>
    ...
    return (
        <ConfigurationSettingsField className="bg-pk-surface-secondary">
            ...
            <LinkButton
                variant="secondary"
                className="mt-8 border border-pk-content-tertiary text-pk-content-primary bg-pk-surface-primary"
                href="https://www.khulnasoft.com/docs/enterprise/setup-khulnasoft/scm-integration"
                isExternalUrl={true}
            >
                Documentation
            </LinkButton>
