...
import { BlockedRepository, ListBlockedRepositoriesResponse } from "@khulnasoft/public-api/lib/khulnasoft/v1/installation_pb";
...
function Details(props: {
    ...
    return (
        <div className="border-gray-200 dark:border-gray-800 -mx-6 px-6 py-4 flex flex-col">
            {props.error ? (
                <div className="bg-kumquat-light rounded-md p-3 text-khulnasoft-red text-sm mb-2">{props.error}</div>
            ) : null}
            <TextInputField
