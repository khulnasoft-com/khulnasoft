...
var databaseCmd = &cobra.Command{
	...
	Long: `Uses the default db env config of a Khulnasoft deployment to try and
connect to a MySQL database, specifically DB_HOST, DB_PORT, DB_PASSWORD,
DB_CA_CERT and DB_USER(=khulnasoft)`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Must be "khulnasoft"
		// Align to https://github.com/khulnasoft-com/khulnasoft/blob/884d922e8e33d8b936ec18d7fe3c8dcffde42b5a/components/khulnasoft-db/go/conn.go#L37
		cfg.DBName = "khulnasoft"
...
func init() {
	...
	databaseCmd.Flags().StringP("username", "u", envOrDefault("DB_USERNAME", "khulnasoft"), "Username to use when connected")
