...
var khulnasoftHost = os.Getenv("KHULNASOFT_HOST")
...
The returned command requires SSH keys to be configured with Khulnasoft.
See %s/user/keys for a guide on setting them up.
`, khulnasoftHost), RunE: func(cmd *cobra.Command, args []string) error {
