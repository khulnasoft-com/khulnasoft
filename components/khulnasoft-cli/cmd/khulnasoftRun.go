...
// khulnasoftRunCmd represents the khulnasoftRun command
var khulnasoftRunCmd = &cobra.Command{
	Use:    "__khulnasoft_run [<pathToExecutable>]",
	Short:  "Used by Khulnasoft to ensure smooth operation",
	Hidden: true,
...
func init() {
	rootCmd.AddCommand(khulnasoftRunCmd)
}
