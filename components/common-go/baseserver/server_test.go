...
func TestServer_Metrics_HTTP(t *testing.T) {
	...
	count, err := testutil.GatherAndCount(registry, "khulnasoft_http_request_duration_seconds", "khulnasoft_http_response_size_bytes", "khulnasoft_http_requests_inflight")
	require.NoError(t, err)
