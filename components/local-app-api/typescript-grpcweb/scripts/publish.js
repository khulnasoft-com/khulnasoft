...
const supervisorPckPath = path.join(
    process.cwd(),
    "components-supervisor-api-typescript-grpcweb--publish/components-supervisor-api-typescript-grpcweb--lib/package",
);
...
require(path.join(
    process.cwd(),
    "components-local-app-api-typescript-grpcweb--scripts/components-khulnasoft-protocol--scripts/publish.js",
));
