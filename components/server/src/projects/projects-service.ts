...
import { DBWithTracing, ProjectDB, TracedWorkspaceDB, WebhookEventDB, WorkspaceDB } from "@khulnasoft/khulnasoft-db/lib";
import {
    Branch,
    PrebuildWithStatus,
    CreateProjectParams,
...
export class ProjectsService {
    ...
    public async getRecentWebhookEvent(
        ...
        if (repoService) {
            try {
                const webhookEnabled = await repoService.isKhulnasoftWebhookEnabled(user, project.cloneUrl);
