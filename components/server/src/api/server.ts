...
import { HelloService } from "@khulnasoft/public-api/lib/khulnasoft/experimental/v1/dummy_connect";
import { StatsService } from "@khulnasoft/public-api/lib/khulnasoft/experimental/v1/stats_connect";
import { TeamsService as TeamsServiceDefinition } from "@khulnasoft/public-api/lib/khulnasoft/experimental/v1/teams_connect";
import { OrganizationService } from "@khulnasoft/public-api/lib/khulnasoft/v1/organization_connect";
import { WorkspaceService } from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_connect";
import { AuditLogService as AuditLogServiceFromAPI } from "@khulnasoft/public-api/lib/khulnasoft/v1/auditlogs_connect";
import { UserService } from "@khulnasoft/public-api/lib/khulnasoft/v1/user_connect";
import { ConfigurationService } from "@khulnasoft/public-api/lib/khulnasoft/v1/configuration_connect";
import { AuthProviderService } from "@khulnasoft/public-api/lib/khulnasoft/v1/authprovider_connect";
import { EnvironmentVariableService } from "@khulnasoft/public-api/lib/khulnasoft/v1/envvar_connect";
...
import { SCMService } from "@khulnasoft/public-api/lib/khulnasoft/v1/scm_connect";
import { SSHService } from "@khulnasoft/public-api/lib/khulnasoft/v1/ssh_connect";
...
import { VerificationService } from "@khulnasoft/public-api/lib/khulnasoft/v1/verification_connect";
...
import { InstallationService } from "@khulnasoft/public-api/lib/khulnasoft/v1/installation_connect";
import { RateLimitter } from "../rate-limitter";
import { TokenServiceAPI } from "./token-service-api";
import { TokenService } from "@khulnasoft/public-api/lib/khulnasoft/v1/token_connect";
                ...
                return (...args: any[]) => {
                    ...
                    const handleError = (reason: unknown) => {
                        ...
                        if (
                            ...
                            // Compare https://linear.app/khulnasoft/issue/ENT-232 and https://github.com/khulnasoft-com/khulnasoft/pull/19827
                    ...
                    if (grpc_type === "unary" || grpc_type === "client_stream") {
                        return withRequestContext(async () => {
                            ...
                            if (
                                isCellDisabled &&
                                requestContext.requestMethod === "khulnasoft.v1.UserService/getAuthenticatedUser"
                            ) {
