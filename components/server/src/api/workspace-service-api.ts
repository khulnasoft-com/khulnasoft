...
import { WorkspaceService as WorkspaceServiceInterface } from "@khulnasoft/public-api/lib/khulnasoft/v1/workspace_connect";
import {
...
import { isWorkspaceId } from "@khulnasoft/khulnasoft-protocol/lib/util/parse-workspace-id";
