...
import { User } from "@khulnasoft/khulnasoft-protocol/lib/protocol";
import * as util from "util";
import express from "express";
import { inject, injectable } from "inversify";
import { BearerAuth } from "../auth/bearer-authenticator";
import { WithFunctionAccessGuard } from "../auth/function-access";
import { CodeSyncResourceDB, ALL_SERVER_RESOURCES, ServerResource, SyncResource } from "@khulnasoft/khulnasoft-db/lib";
import {
    DeleteRequest,
    DeleteResponse,
    DownloadUrlRequest,
