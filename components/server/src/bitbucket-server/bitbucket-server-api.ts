...
export class BitbucketServerApi {
    ...
    async getBranchLatestCommit(
        ...
        // @see https://bitbucket.khulnasoft-dev.com/rest/api/1.0/users/huiwen/repos/mustard/branches?filterText=develop
    ...
    async getTagLatestCommit(
        ...
        // @see https://bitbucket.khulnasoft-dev.com/rest/api/1.0/users/huiwen/repos/mustard/tags?filterText=11
        const queryParam = qs.stringify({
...
export namespace BitbucketServer {
    ...
    export interface PullRequest {
        ...
        links: {
            self: [
                {
                    //"https://bitbucket.khulnasoft-self-hosted.com/projects/FOO/repos/repo123/pull-requests/1"
                    href: string;
                },
            ];
        };
