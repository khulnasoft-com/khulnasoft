...
import { IAnalyticsWriter, IdentifyMessage, PageMessage, TrackMessage } from "@khulnasoft/khulnasoft-protocol/lib/analytics";
...
export async function trackSignup(user: User, request: Request, analytics: IAnalyticsWriter) {
    ...
    analytics.track({
        ...
        properties: {
            ...
            qualified: !!request.cookies["khulnasoft-marketing-website-visited"],
