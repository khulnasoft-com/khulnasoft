...
import { PrebuiltWorkspace, User, UserEnvVar, Workspace, WorkspaceType } from "@khulnasoft/khulnasoft-protocol/lib/protocol";
import {
    OrgMemberInfo,
    Organization,
    TeamMemberInfo,
    ...
    public async workspaceLikeResourceGuardsCanAcccess() {
        ...
        const createWorkspace = (ownerId: string, type: WorkspaceType): Workspace => {
            return {
                ...
                context: {
                    title: "khulnasoft-com/khulnasoft",
        ...
        const createInstance = (): WorkspaceInstance => {
            return {
                ...
                region: "local",
                configuration: {
                    ideImage: "khulnasoft/workspace-full:latest",
                },
                status: {
                    version: 1,
                    conditions: {},
                ...
                workspaceImage: "khulnasoft/workspace-full:latest",
            };
        };
        const createPrebuild = (): PrebuiltWorkspace => {
            return {
                ...
                cloneURL: "https://github.com/khulnasoft-com/khulnasoft",
                commit: "sha123123213",
                creationTime: new Date(2000, 1, 2).toISOString(),
                state: "available",
                statusVersion: 1,
