...
import { EmailDomainFilterDB, TeamDB } from "@khulnasoft/khulnasoft-db/lib";
...
export class InstallationService {
    ...
    async getOnboardingState(): Promise<KhulnasoftServer.OnboardingState> {
        // Find useful details about the state of the Khulnasoft installation.
