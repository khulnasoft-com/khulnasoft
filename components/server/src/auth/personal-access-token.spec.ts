...
describe("PersonalAccessToken", () => {
    it("should parse token successfully", () => {
        const token = "khulnasoft_pat_GrvGthczSRf3ypqFhNtcRiN5fK6CV7rdCkkPLfpbc_4." + "test".repeat(10);
    ...
    it("should parse token and throw an error", () => {
        const tokens = [
            "khulnasoft_pat_GrvGthczSRf3ypqFhNtcRiN5fK6CV7rdCkkPLfpbc_4.", // no value
            `khulnasoft_pat_.${"test".repeat(10)}`, // no signature
