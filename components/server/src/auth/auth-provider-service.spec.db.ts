...
import { AuthProviderInfo, Organization, User } from "@khulnasoft/khulnasoft-protocol";
...
import { AuthProviderEntry } from "@khulnasoft/khulnasoft-protocol";
    ...
    const expectedEntry = () =>
        <Partial<AuthProviderEntry>>{
            ...
            oauth: {
                ...
                callBackUrl: "https://khulnasoft.com/auth/callback",
                clientId: "123",
