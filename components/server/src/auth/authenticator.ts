...
import { BUILTIN_INSTLLATION_ADMIN_USER_ID, TeamDB } from "@khulnasoft/khulnasoft-db/lib";
...
export class Authenticator {
    ...
    private async parseState(state: string): Promise<AuthFlow> {
        ...
        // See https://github.com/khulnasoft-com/ops/pull/9398/files
        //
