...
import { AuthProviderEntry as AuthProviderEntry, AuthProviderInfo, OAuth2Config, User } from "@khulnasoft/khulnasoft-protocol";
import { AuthProviderParams } from "./auth-provider";
import { AuthProviderEntryDB, TeamDB } from "@khulnasoft/khulnasoft-db/lib";
    ...
    private initializeNewProvider(newEntry: AuthProviderEntry.NewEntry): AuthProviderEntry {
        ...
        switch (type) {
            ...
            case "AzureDevOps":
                ...
                if (this.config.hostUrl.url.host === "khulnasoft.com") {
