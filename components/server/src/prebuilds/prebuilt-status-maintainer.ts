...
import { WorkspaceDB, TracedWorkspaceDB, DBWithTracing } from "@khulnasoft/khulnasoft-db/lib";
import { v4 as uuidv4 } from "uuid";
import { HeadlessWorkspaceEvent } from "@khulnasoft/khulnasoft-protocol/lib/headless-workspace-log";
...
const DEFAULT_STATUS_DESCRIPTION = "Open a prebuilt online workspace in Khulnasoft";
const NON_PREBUILT_STATUS_DESCRIPTION = "Open an online workspace in Khulnasoft";
