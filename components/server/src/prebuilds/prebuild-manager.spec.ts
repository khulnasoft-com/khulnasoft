...
import { TracedWorkspaceDB, WebhookEventDB } from "@khulnasoft/khulnasoft-db/lib";
...
import { CommitContext, Project, ProjectSettings, Repository, WorkspaceConfig } from "@khulnasoft/khulnasoft-protocol";
    ...
    const checkPrebuildPreconditionCases = [
        {
            title: "no-config",
            shouldRun: false,
            reason: "no-khulnasoft-config-in-repo",
        ...
        },
        {
            title: "no-tasks",
            shouldRun: false,
            reason: "no-tasks-in-khulnasoft-config",
