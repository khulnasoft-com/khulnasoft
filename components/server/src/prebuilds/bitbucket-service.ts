...
export class BitbucketService extends RepositoryService {
    ...
    public async isKhulnasoftWebhookEnabled(user: User, cloneUrl: string): Promise<boolean> {
        try {
            ...
            console.error("Failed to check if Khulnasoft webhook is enabled.", error, { cloneUrl });
