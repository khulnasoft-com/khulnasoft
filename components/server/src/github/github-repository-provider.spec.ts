...
class TestGithubContextRepositoryProvider {
    ...
    static readonly AUTH_HOST_CONFIG: Partial<AuthProviderParams> = {
        ...
        host: "github.com",
        oauth: {
            callBackUrl: "https://khulnasoft.example.com/auth/github/callback",
        } as any,
    };
    ...
    @test public async testSearchRepos_matchesAgainstWholePath() {
        ...
        const resultDoesNotMatchSubstring = await this.provider.searchRepos(
            this.user,
            "khulnasoft-integration-test/exampl",
            100,
        );
    ...
    @test public async testGetUserRepos() {
        ...
        expect(result).to.deep.include({ url: "https://github.com/khulnasoft-integration-test/example", name: "example" });
    }
}
