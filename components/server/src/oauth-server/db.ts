...
const localClient: OAuthClient = {
    ...
    name: "Khulnasoft local control client",
    ...
    scopes: [
        { name: "function:getKhulnasoftTokenScopes" },
...
const localCliClientID = "khulnasoft-cli";
...
const jetBrainsGateway: OAuthClient = {
    id: "jetbrains-gateway-khulnasoft-plugin",
    name: "JetBrains Gateway Khulnasoft Plugin",
    // Set of valid redirect URIs
    ...
    redirectUris: Array.from(
        { length: 20 },
        (_, i) => `http://127.0.0.1:${63342 + i}/api/khulnasoft/oauth/authorization_code`,
    ),
    allowedGrants: ["authorization_code"],
    scopes: [
        { name: "function:getKhulnasoftTokenScopes" },
...
function createVSCodeClient(protocol: string, displayName: string): OAuthClient {
    return {
        id: `${protocol}-khulnasoft`,
        name: `${displayName}: Khulnasoft extension`,
        redirectUris: [protocol + "://khulnasoft.khulnasoft-desktop/complete-khulnasoft-auth"],
        allowedGrants: ["authorization_code"],
        scopes: [
            { name: "function:getKhulnasoftTokenScopes" },
            { name: "function:getLoggedInUser" },
...
const desktopClient: OAuthClient = {
    id: "khulnasoft-desktop",
    name: "Khulnasoft Desktop",
    redirectUris: ["khulnasoft://complete-auth"],
    allowedGrants: ["authorization_code"],
    scopes: [
        { name: "function:getKhulnasoftTokenScopes" },
        { name: "function:getLoggedInUser" },
...
const toolbox: OAuthClient = {
    id: "toolbox-gateway-khulnasoft-plugin",
    name: "JetBrains Toolbox Khulnasoft Plugin",
    redirectUris: ["jetbrains://gateway/io.khulnasoft.toolbox.gateway/auth"],
    allowedGrants: ["authorization_code"],
    scopes: [
        { name: "function:getKhulnasoftTokenScopes" },
        { name: "function:getLoggedInUser" },
