...
import { IssueContext, User, PullRequestContext, Repository, Token } from "@khulnasoft/khulnasoft-protocol";
import {
    GitHubOAuthScopes,
    GitLabOAuthScopes,
...
export namespace DevData {
    ...
    export function createGitHubTestToken(): Token {
        if (!process.env.KHULNASOFT_TEST_TOKEN_GITHUB) {
            console.error(
                `KHULNASOFT_TEST_TOKEN_GITHUB env var is not set\n\n\t export KHULNASOFT_TEST_TOKEN_GITHUB='{"username": "khulnasoft-test", "value": $GITHUB_TOKEN}'`,
            );
        }
        return {
            ...getTokenFromEnv("KHULNASOFT_TEST_TOKEN_GITHUB"),
    ...
    export function createGitlabTestToken(): Token {
        return {
            ...getTokenFromEnv("KHULNASOFT_TEST_TOKEN_GITLAB"),
    ...
    export function createAzureDevOpsTestToken(): Token {
        return {
            ...getTokenFromEnv("KHULNASOFT_TEST_TOKEN_AZURE_DEVOPS"),
    ...
    export function createBitbucketTestToken(): Token {
        const result = {
            ...getTokenFromEnv("KHULNASOFT_TEST_TOKEN_BITBUCKET"),
            scopes: [],
        };
        return result;
    }
...
export namespace DevTestHelper {
    export const AzureTestEnv = "KHULNASOFT_TEST_TOKEN_AZURE_DEVOPS";
