...
import { WorkspaceDB } from "@khulnasoft/khulnasoft-db/lib";
import { KhulnasoftServer, Snapshot } from "@khulnasoft/khulnasoft-protocol";
...
export class SnapshotService {
    ...
    public async createSnapshot(options: KhulnasoftServer.TakeSnapshotOptions, snapshotUrl: string): Promise<Snapshot> {
        const id = uuidv4();
