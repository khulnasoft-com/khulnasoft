...
export class MockImageSourceProvider extends ImageSourceProvider {
    public imageSource: WorkspaceImageSource = { baseImageResolved: "khulnasoft/workspace-full:latest" };
...
describe("WorkspaceFactory", async () => {
    ...
    it("createForPrebuiltWorkspace_noPrebuild", async () => {
        ...
        const contextURL = "https://github.com/khulnasoft-com/khulnasoft/tree/gpl/test";
