...
import { User, WorkspaceContext, WithEnvvarsContext } from "@khulnasoft/khulnasoft-protocol";
import { injectable } from "inversify";
import { EnvVarWithValue } from "@khulnasoft/khulnasoft-protocol/lib/protocol";
