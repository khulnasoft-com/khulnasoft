...
import { WorkspaceDB, DBWithTracing, TracedWorkspaceDB } from "@khulnasoft/khulnasoft-db/lib";
import {
    CommitContext,
    PrebuiltWorkspace,
...
import { OpenPrebuildContext, WithDefaultConfig } from "@khulnasoft/khulnasoft-protocol/lib/protocol";
