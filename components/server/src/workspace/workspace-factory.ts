...
import { DBWithTracing, TracedWorkspaceDB, WorkspaceDB, TeamDB } from "@khulnasoft/khulnasoft-db/lib";
import {
...
import { generateWorkspaceID } from "@khulnasoft/khulnasoft-protocol/lib/util/generate-workspace-id";
