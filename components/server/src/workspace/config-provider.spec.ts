...
const globalDefaultImage = "khulnasoft/global-default";
const baseOrgImage = "khulnasoft/org-default";
const baseYamlImage = "khulnasoft/yml";
                ...
                bind(HostContextProvider).toConstantValue({
                    get(hostname: string) {
                        return {
                            ...
                            services: {
                                fileProvider: {
                                    getKhulnasoftFileContent: async () => {
