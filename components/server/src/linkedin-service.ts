...
import { LinkedInProfile, User } from "@khulnasoft/khulnasoft-protocol/lib/protocol";
import { log } from "@khulnasoft/khulnasoft-protocol/lib/util/logging";
import { LinkedInProfileDB } from "@khulnasoft/khulnasoft-db/lib";
...
export class LinkedInService {
    ...
    async connectWithLinkedIn(user: User, code: string): Promise<LinkedInProfile> {
        ...
        // Note: The unique mapping from LinkedIn profile to Khulnasoft user is guaranteed by the DB.
