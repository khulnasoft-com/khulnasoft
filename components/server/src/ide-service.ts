...
import { IDESettings, User, Workspace } from "@khulnasoft/khulnasoft-protocol";
import { IDEClient, IDEOption, IDEOptions, IDESettingsVersion } from "@khulnasoft/khulnasoft-protocol/lib/ide-protocol";
