...
import { CommitContext, User, WorkspaceConfig } from "@khulnasoft/khulnasoft-protocol";
...
export class ConfigurationService {
    ...
    async guessRepositoryConfiguration(
        ...
        return `# This configuration file was automatically generated by Khulnasoft.
# Please adjust to your needs (see https://www.khulnasoft.com/docs/introduction/learn-khulnasoft/khulnasoft-yaml)
...
`;
    ...
    async fetchRepositoryConfiguration(
        ...
        const configString = await fileProvider.getKhulnasoftFileContent(commitContext, user);
        return configString;
    }
