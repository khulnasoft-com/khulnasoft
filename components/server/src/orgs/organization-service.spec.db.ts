...
import { BUILTIN_INSTLLATION_ADMIN_USER_ID, TypeORM, UserDB } from "@khulnasoft/khulnasoft-db/lib";
import { Organization, OrganizationSettings, TeamMemberRole, User } from "@khulnasoft/khulnasoft-protocol";
                ...
                ideOptions: {
                    options: {
                        code: {
                            ...
                            title: "VS Code",
                            type: "browser",
                            logo: "https://ide.khulnasoft.com/image/ide-logo/vscode.svg",
                            label: "Browser",
                            image: "bar",
                            latestImage: "baz",
                        ...
                        intellij: {
                            ...
                            title: "Intellij",
                            type: "desktop",
                            logo: "https://ide.khulnasoft.com/image/ide-logo/intellij.svg",
                            label: "Desktop",
                            image: "bar",
                            latestImage: "baz",
