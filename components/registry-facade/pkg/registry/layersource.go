...
const (
	...
	labelSkipNLayer = "skip-n.registry-facade.khulnasoft.com"
)
...
const (
	envPrefixSet     = "KHULNASOFT_ENV_SET_"
	envPrefixAppend  = "KHULNASOFT_ENV_APPEND_"
	envPrefixPrepend = "KHULNASOFT_ENV_PREPEND_"
)
