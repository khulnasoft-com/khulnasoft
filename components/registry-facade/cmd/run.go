...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/registry-facade/api/config"
	"github.com/khulnasoft-com/khulnasoft/registry-facade/pkg/registry"
)
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		gpreg := prometheus.WrapRegistererWithPrefix("khulnasoft_registry_facade_", promreg)
