...
func init() {
	...
	debugCmd.Flags().StringVar(&debugSpec.IdeRef, "ide-ref", "docker.io/khulnasoft/core-dev/build/ide/code:commit-8dd2ddd844f30a4ff66d2704f4714e9da875c7d5", "sets the IDE ref")
	debugCmd.Flags().StringVar(&debugSpec.SupervisorRef, "supervisor-ref", "docker.io/khulnasoft/core-dev/build/supervisor:main.2733", "sets the supervisor ref")
}
