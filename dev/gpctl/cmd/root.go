...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/gpctl/pkg/prettyprint"
	"github.com/khulnasoft-com/khulnasoft/gpctl/pkg/util"
)

// rootCmd represents the base command when called without any subcommands
var rootCmd = &cobra.Command{
	Use:   "gpctl",
	Short: "Gpctl controls a Khulnasoft installation",
