...
import (
	...
	api "github.com/khulnasoft-com/khulnasoft/khulnasoft-protocol"
...
func init() {
	...
	usersCmd.PersistentFlags().StringVar(&usersCmdOpts.address, "address", "wss://khulnasoft.com/api/v1", "Address of the API endpoint. Must be in the form <host>:<port>.")
