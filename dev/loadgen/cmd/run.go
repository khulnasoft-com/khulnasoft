...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/loadgen/pkg/loadgen"
	"github.com/khulnasoft-com/khulnasoft/loadgen/pkg/observer"
		...
		template := &api.StartWorkspaceRequest{
			...
			Spec: &api.StartWorkspaceSpec{
				IdeImage: &api.IDEImage{
					WebRef: "docker.io/khulnasoft/core-dev/build/ide/code:commit-8c1466008dedabe79d82cbb91931a16f7ce7994c",
				},
				...
				Initializer: &csapi.WorkspaceInitializer{
					Spec: &csapi.WorkspaceInitializer_Git{
						Git: &csapi.GitInitializer{
							...
							CloneTaget:       "main",
							RemoteUri:        "https://github.com/khulnasoft-com/khulnasoft.git",
				...
				Timeout:           "5m",
				WorkspaceImage:    "docker.io/khulnasoft-dev/workspace-images:3fcaad7ba5a5a4695782cb4c366b82f927f1e6c1cf0c88fd4f14d985f7eb21f6",
				WorkspaceLocation: "khulnasoft",
				Envvars: []*api.EnvironmentVariable{
					{
						Name:  "THEIA_SUPERVISOR_TOKENS",
						Value: `[{"token":"foobar","host":"khulnasoft-staging.com","scope":["function:getWorkspace","function:getLoggedInUser","function:getWorkspaceOwner","function:getWorkspaceUsers","function:isWorkspaceOwner","function:controlAdmission","function:setWorkspaceTimeout","function:getWorkspaceTimeout","function:sendHeartBeat","function:getOpenPorts","function:openPort","function:closePort","function:generateNewKhulnasoftToken","function:takeSnapshot","function:stopWorkspace","resource:workspace::fa498dcc-0a84-448f-9666-79f297ad821a::get/update","resource:workspaceInstance::e0a17083-6a78-441a-9b97-ef90d6aff463::get/update/delete","resource:snapshot::*::create/get","resource:khulnasoftToken::*::create","resource:userStorage::*::create/get/update"],"expiryDate":"2020-12-01T07:55:12.501Z","reuse":2}]`,
					},
				},
			},
