...
var (
	holder    = flag.String("c", "Khulnasoft GmbH", "copyright holder")
...
func removeLicense(path string, fmode os.FileMode, tmpl *template.Template, data *copyrightData) (haslic bool, modified bool, err error) {
	...
	b = bytes.ReplaceAll(b, []byte("Copyright (c) 2021 Khulnasoft GmbH."), []byte("Copyright (c) 2022 Khulnasoft GmbH."))
	b = bytes.ReplaceAll(b, []byte("Copyright (c) 2020 Khulnasoft GmbH."), []byte("Copyright (c) 2022 Khulnasoft GmbH."))
