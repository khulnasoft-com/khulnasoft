...
1. We need to keep workspace alive, so edit khulnasoft-cli to build a new tmp exec file with command to keep heartbeat: send heartbeat every 30 seconds
...
1. Many connections to learn the cost of single connection in terms of memory and CPU
    ...
    > Fixed with [PR](https://github.com/khulnasoft-com/khulnasoft/pull/7772)
...
4. Try dropping and reopening connections to see whether ws-proxy leaks memory on such connections
    ...
    🟠 Memory leak appeared and fixed by [this commit](https://github.com/khulnasoft-com/khulnasoft/pull/7772/commits/e5c3defe2588774cf713b948f0dac35ef94350e9)
