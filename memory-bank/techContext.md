...
### Local Development
The project uses a Khulnasoft-based development workflow (dogfooding), with the following key aspects:

1. **Khulnasoft Workspace**: Development occurs in Khulnasoft workspaces defined by `.khulnasoft.yml`
...
Khulnasoft uses two primary approaches for building components:
