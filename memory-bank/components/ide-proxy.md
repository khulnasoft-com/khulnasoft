...
The IDE Proxy is a lightweight component in Khulnasoft that serves static assets related to IDEs, including IDE logos, binaries, and configuration files. It acts as a centralized service for delivering IDE-related static content to other components of the Khulnasoft platform, particularly the dashboard and workspaces.
...
- Serve the Khulnasoft Local Companion application binaries
...
- `static/bin/`: Contains binaries for Khulnasoft Local Companion (added during build)
...
- Khulnasoft Local Companion for various platforms:
  - Linux (x86_64)
  - macOS (x86_64)
  - Windows (x86_64)
...
- `local-app`: For Khulnasoft Local Companion binaries
...
4. **Local App**: Serves the Khulnasoft Local Companion binaries
...
2. Provide downloadable binaries for Khulnasoft Local Companion
