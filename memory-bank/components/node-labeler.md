...
- Support the Khulnasoft workspace infrastructure
...
- `--namespace`: Namespace where Khulnasoft components are running (default: default)
...
- `khulnasoft.com/registry-facade_ready_ns_<namespace>`: Indicates registry-facade is ready
- `khulnasoft.com/ws-daemon_ready_ns_<namespace>`: Indicates ws-daemon is ready
