...
The Local App component in Khulnasoft provides tools for interacting with Khulnasoft workspaces from a user's local machine. It consists of two main applications: the Khulnasoft CLI (`khulnasoft-cli`) and the Local Companion App (`khulnasoft-local-companion`). These tools enable users to connect to their remote Khulnasoft workspaces, access ports, establish SSH connections, and manage workspaces from their local environment.

## Purpose

The primary purposes of the Local App component are:
- Provide a command-line interface for interacting with Khulnasoft
- Enable SSH access to Khulnasoft workspaces
- Establish secure tunnels to workspace ports
- Manage authentication and tokens for Khulnasoft access
...
1. **Khulnasoft CLI**: A command-line tool for interacting with Khulnasoft
...
- `main/khulnasoft-cli/main.go`: Entry point for the CLI application
- `main/khulnasoft-local-companion/main.go`: Entry point for the Local Companion App
...
The Khulnasoft CLI provides various commands for interacting with Khulnasoft:

- `khulnasoft login`: Authenticate with Khulnasoft
- `khulnasoft workspace`: Manage workspaces
- `khulnasoft ssh`: SSH into a workspace
- `khulnasoft port`: Forward ports from a workspace
- `khulnasoft context`: Manage Khulnasoft contexts (different Khulnasoft installations)
- `khulnasoft completion`: Generate shell completion scripts
...
- `components/khulnasoft-protocol`: For Khulnasoft API communication
...
1. **Khulnasoft Server**: For authentication and workspace information
...
3. **Configuration File**: Located at `~/.khulnasoft/config.yaml`
...
4. Integrate Khulnasoft with local development tools
