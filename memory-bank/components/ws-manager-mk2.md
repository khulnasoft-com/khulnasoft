...
The Workspace Manager MK2 (ws-manager-mk2) is a Kubernetes controller responsible for managing the lifecycle of workspaces in Khulnasoft. It orchestrates the creation, monitoring, and deletion of workspace pods and related resources in the Kubernetes cluster.
...
- Depends on other Khulnasoft components for full functionality
