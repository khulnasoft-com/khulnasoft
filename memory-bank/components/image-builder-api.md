...
## Overview
The Image Builder API defines the gRPC interfaces for the Image Builder service, which is responsible for building Docker images for workspaces within the Khulnasoft platform. This API enables the dynamic creation, management, and monitoring of workspace image builds.
