...
import (
	...
	cgroups_v2 "github.com/khulnasoft-com/khulnasoft/common-go/cgroups/v2"
	ctntcfg "github.com/khulnasoft-com/khulnasoft/content-service/api/config"
	"github.com/khulnasoft-com/khulnasoft/content-service/pkg/storage"
	"github.com/khulnasoft-com/khulnasoft/test/pkg/agent/daemon/api"
...
func (*DaemonAgent) VerifyRateLimitingRule(args *api.VerifyRateLimitingRuleRequest, resp *api.VerifyRateLimitingRuleResponse) error {
	*resp = api.VerifyRateLimitingRuleResponse{}
	...
	khulnasoftTable := &nftables.Table{
		Name:   "khulnasoft",
	...
	// Check if set exists.
	_, err = nftconn.GetSetByName(khulnasoftTable, "ws-connections")
	if err != nil {
