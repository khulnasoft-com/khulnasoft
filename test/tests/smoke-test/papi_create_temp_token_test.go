...
import (
	...
	v1 "github.com/khulnasoft-com/khulnasoft/components/public-api/go/v1"
	v1connect "github.com/khulnasoft-com/khulnasoft/components/public-api/go/v1/v1connect"
)

/*
*
export TEST_CREATE_TMP_TOKEN=true
export KHULNASOFT_HOST=hw-token-exp-1084.preview.khulnasoft-dev.com
...
go test -run "^TestCreateTemporaryAccessToken" github.com/khulnasoft-com/khulnasoft/test/tests/smoke-test -v -count=1
*/
...
func TestCreateTemporaryAccessToken(t *testing.T) {
	...
	khulnasoftHost, _ := os.LookupEnv("KHULNASOFT_HOST")
	adminPAT, _ := os.LookupEnv("INSTALLATION_ADMIN_PAT")
	targetUserID, _ := os.LookupEnv("TARGET_USER_ID")
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*5)
	defer cancel()

	assertGetUser(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	newTargetToken := assertTemporaryAccessToken(ctx, t, khulnasoftHost, adminPAT, targetUserID, 60, "")
	if newTargetToken == "" {
		return
	}

	assertGetUser(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	assertGetUser(ctx, t, khulnasoftHost, newTargetToken, targetUserID, "")
}
...
func TestCreateTemporaryAccessTokenDeniedToCreateInstallationAdmin(t *testing.T) {
	...
	assertGetUser(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	assertTemporaryAccessToken(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, 60, "permission_denied")
}
...
func TestCreateTemporaryAccessTokenWithNotFoundUser(t *testing.T) {
	...
	assertGetUser(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	assertTemporaryAccessToken(ctx, t, khulnasoftHost, adminPAT, "00000000-0000-0000-0000-000000000000", 60, "not_found")
}
...
func TestCreateTemporaryAccessTokenViaMember(t *testing.T) {
	...
	assertGetUser(ctx, t, khulnasoftHost, memberUserPAT, memberUserID, "")
	assertTemporaryAccessToken(ctx, t, khulnasoftHost, memberUserPAT, targetUserID, 60, "permission_denied")
}
...
func TestCreateTemporaryAccessTokenExpiry(t *testing.T) {
	...
	assertGetUser(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	newTargetToken := assertTemporaryAccessToken(ctx, t, khulnasoftHost, adminPAT, targetUserID, 3, "")
	if newTargetToken == "" {
		return
	}
	assertGetUser(ctx, t, khulnasoftHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	...
	assertGetUser(ctx, t, khulnasoftHost, newTargetToken, targetUserID, "unauthenticated")
}
...
func TestCreateTemporaryAccessTokenCreateEnv(t *testing.T) {
	...
	assertCreateEnvVar(ctx, t, khulnasoftHost, newTargetToken, "foo", "boo")
}

func assertTemporaryAccessToken(ctx context.Context, t *testing.T, khulnasoftHost, userToken, targetUserID string, expirySeconds int32, wantedErrMsg string) string {
	useCookie := !strings.HasPrefix(userToken, "khulnasoft_pat_")
	v1Http, v1Opts, v1Host := getPAPIConnSettings(khulnasoftHost, userToken, useCookie, false)
...
func assertGetUser(ctx context.Context, t *testing.T, khulnasoftHost, userToken string, wantedUser, wantedErrMsg string) {
	useCookie := !strings.HasPrefix(userToken, "khulnasoft_pat_")
	v1Http, v1Opts, v1Host := getPAPIConnSettings(khulnasoftHost, userToken, useCookie, false)
...
func assertCreateEnvVar(ctx context.Context, t *testing.T, khulnasoftHost, userToken string, envVarName, envVarVal string) {
	useCookie := !strings.HasPrefix(userToken, "khulnasoft_pat_")
	v1Http, v1Opts, v1Host := getPAPIConnSettings(khulnasoftHost, userToken, useCookie, false)
