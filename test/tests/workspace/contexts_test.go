...
import (
	...
	"github.com/khulnasoft-com/khulnasoft/test/pkg/report"
)
	...
	tests := []ContextTest{
		{
			...
			ContextURL:     "github.com/khulnasoft-com/template-golang-cli",
			WorkspaceRoot:  "/workspace/template-golang-cli",
			ExpectedBranch: "main",
		},
		{
			Name:           "open branch",
			ContextURL:     "github.com/khulnasoft-com/khulnasoft-test-repo/tree/integration-test-1",
			WorkspaceRoot:  "/workspace/khulnasoft-test-repo",
			ExpectedBranch: "integration-test-1",
		},
		{
			// Branch name decisions are not tested in the workspace as it is the server side logic
			Name:          "open issue",
			ContextURL:    "github.com/khulnasoft-com/khulnasoft-test-repo/issues/88",
			WorkspaceRoot: "/workspace/khulnasoft-test-repo",
		},
		{
			Name:           "open tag",
			ContextURL:     "github.com/khulnasoft-com/khulnasoft-test-repo/tree/integration-test-context-tag",
			WorkspaceRoot:  "/workspace/khulnasoft-test-repo",
			ExpectedBranch: "HEAD",
		},
		{
		...
		{
			Name:           "empty repo",
			ContextURL:     "github.com/khulnasoft-com/empty",
