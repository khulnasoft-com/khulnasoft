...
var repos = []struct {
	...
	{
		RemoteUri:        "https://github.com/khulnasoft-com/khulnasoft",
		CloneTarget:      "main",
		ExpectedBranch:   "main",
	...
	{
		RemoteUri:        "https://github.com/khulnasoft-com/workspace-images",
		CloneTarget:      "main",
		ExpectedBranch:   "main",
		CheckoutLocation: "workspace-images",
	},
	{
		RemoteUri:        "https://github.com/khulnasoft-com/dazzle",
		CloneTarget:      "main",
		ExpectedBranch:   "main",
	...
	{
		RemoteUri:        "https://github.com/khulnasoft-com/ws-manager-integration-test",
...
func TestMultiRepoWorkspaceSuccess(t *testing.T) {
	f := features.New("multi-repo").WithLabel("component", "ws-manager").Assess("can create multi repo workspace", func(testCtx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
		...
		multiRepoInit := func(swr *wsmanapi.StartWorkspaceRequest) error {
			...
			swr.Spec.WorkspaceLocation = "khulnasoft"
			return nil
		}
